...
!     gfdl_mp - if true, GFDL microphysics is used in the model and ice cloud
!              condensate is added to the cloud water condensate
!
...
!            add use of guess file later for regional mode.
  ...
  namelist/setup/gencode,factqmin,factqmax,clip_supersaturation, &
       ...
       luse_obsdiag,id_drifter,verbose,lsingleradar,singleradar,lnobalance,gfdl_mp
