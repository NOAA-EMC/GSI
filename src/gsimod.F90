...
! !USES:
  ...
  use jfunc, only: iout_iter,iguess,miter,factqmin,factqmax,factv,niter,niter_no_qc,biascor,&
     ...
     bcoption,diurnalbc,print_diag_pcg,tsensible,lgschmidt,diag_precon,step_start,use_rhtot,do_gfsphys,clip_supersaturation
...
!            add use of guess file later for regional mode.
  ...
  namelist/setup/gencode,factqmin,factqmax,clip_supersaturation,factv,deltim,dtphys,&
       ...
       use_gfs_stratosphere,pblend0,pblend1,step_start,diag_precon,lrun_subdirs,use_rhtot,do_gfsphys,use_reflectivity
