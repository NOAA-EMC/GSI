...
! !USES:
  ...
  use gridmod, only: nlat,nlon,nsig,wrf_nmm_regional,nems_nmmb_regional,cmaq_regional,&
     ...
     use_gfs_nemsio,use_fv3hist_nemsio,use_readin_anl_sfcmask,use_sp_eqspace,final_grid_vars,&
...
!  08-31-2017 Li        add use_fv3hist_nemsio for option to read FV3 regriding
!                       sfc history file
!
!EOP
!-------------------------------------------------------------------------
...
!     use_fv3hist_nemsio  - option to use nemsio sfc history file by regriding FV3 grid
...
!            add use of guess file later for regional mode.
  ...
  namelist/setup/gencode,factqmin,factqmax,clip_supersaturation, &
       ...
       lwrite_peakwt,use_gfs_nemsio,use_fv3hist_nemsio,liauon,use_prepb_satwnd,l4densvar,ens_nstarthr,&
