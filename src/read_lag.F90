...
! Declare local parameters
  ...
  real(r_kind),parameter:: pmin=10
  real(r_kind),parameter:: pmax=1000
  real(r_kind),parameter:: lonmin=-180
  real(r_kind),parameter:: lonmax=360
  real(r_kind),parameter:: latmin=-90
  real(r_kind),parameter:: latmax=90
