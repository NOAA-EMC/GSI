...
! Declare local parameters
  integer(i_kind),parameter:: n0=10
...
!    pbc(*,11) contribution from ps observation  term (Jo)
!    pbc(*,12) contribution from t observation  term (Jo)
!    pbc(*,13) contribution from w observation  term (Jo)
!    pbc(*,14) contribution from q observation  term (Jo)
!    pbc(*,15) contribution from spd observation  term (Jo)
!    pbc(*,16) contribution from srw observation  term (Jo)
!    pbc(*,17) contribution from rw observation  term (Jo)
!    pbc(*,18) contribution from dw observation  term (Jo)
!    pbc(*,19) contribution from sst observation  term (Jo)
!    pbc(*,20) contribution from pw observation  term (Jo)
!    pbc(*,21) contribution from pcp observation  term (Jo)
!    pbc(*,22) contribution from oz observation  term (Jo)
!    pbc(*,23) contribution from o3l observation  term (Jo)(not used)
!    pbc(*,24) contribution from gps observation  term (Jo)
!    pbc(*,25) contribution from rad observation  term (Jo)
!    pbc(*,26) contribution from tcp observation  term (Jo)
!    pbc(*,27) contribution from lag observation  term (Jo)
!    pbc(*,28) contribution from colvk observation  term (Jo)
!    pbc(*,29) contribution from aero observation  term (Jo)
!    pbc(*,30) contribution from aerol observation  term (Jo)
!    pbc(*,31) contribution from pm2_5 observation  term (Jo)
!    pbc(*,32) contribution from gust observation  term (Jo)
!    pbc(*,33) contribution from vis observation  term (Jo)
!    pbc(*,34) contribution from pblh observation  term (Jo)
!    pbc(*,35) contribution from wspd10m observation  term (Jo)
!    pbc(*,36) contribution from td2m observation  term (Jo)
!    pbc(*,37) contribution from mxtm observation  term (Jo)
!    pbc(*,38) contribution from mitm observation  term (Jo)
!    pbc(*,39) contribution from pmsl observation  term (Jo)
!    pbc(*,40) contribution from howv observation  term (Jo)
!
