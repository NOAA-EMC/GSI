...
!    forward model
          ...
          !print*,"val= ",val
          !print*,"j1-8= ",pm2_5ptr%ij(1:8)
          !print*,"w1-8= ",pm2_5ptr%wij(1:8)
...
!naero_cmaq_fv3
          iaero=1 
          aeroname=aeronames_cmaq_fv3(iaero) !'aso4i'
          ...
          !print*,"intpm2_5 tlm contribution: ",aeroname,imodes_cmaq_fv3(iaero),pm2_5ptr%pm25wc(imodes_cmaq_fv3(iaero))
          ...
          !print*,"intpm2_5 add contribution: ",iaero,aeroname,imodes_cmaq_fv3(iaero),pm2_5ptr%pm25wc(imodes_cmaq_fv3(iaero))
          val=(w1* spm2_5(j1)+w2* spm2_5(j2)+ &
               w3* spm2_5(j3)+w4* spm2_5(j4)+ &
               w5* spm2_5(j5)+w6* spm2_5(j6)+ &
          ...
          if(luse_obsdiag)then
             if (lsaveobsens) then
                !-- pm2_5ptr%diags%obssen(jiter) =
                !val*pm2_5ptr%raterr2*pm2_5ptr%err2
                call obsdiagNode_set(pm2_5ptr%diags,jiter=jiter,obssen=val*pm2_5ptr%raterr2*pm2_5ptr%err2)
             else
                !-- if (pm2_5ptr%luse) pm2_5ptr%diags%tldepart(jiter)=val
                if (pm2_5ptr%luse) call obsdiagNode_set(pm2_5ptr%diags,jiter=jiter,tldepart=val)
