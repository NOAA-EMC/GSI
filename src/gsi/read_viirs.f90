...
! Declare local variables  
  ...
  integer(i_kind) nchanl,iret,ifov,ich_m15
...
!          write(*,'(a,I8,6F9.3)') 'viirs data : ',itx,data_mesh(7,itx),data_mesh(8,itx),data_mesh(9,itx), &
!                     data_mesh(1+nreal,itx),data_mesh(4+nreal,itx),data_mesh(5+nreal,itx)
...
! and write out data to scratch file for further processing.
  if (mype_sub==mype_root.and.ndata>0) then
     ...
     write(6,'(a,a10,2I8)') 'READ_VIIRS: jsatid,mype, total number of obs info,ndata : ',jsatid,mype,ndata
