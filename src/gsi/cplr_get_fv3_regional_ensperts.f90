...
!  variables for direct reflectivity DA
      call gsi_fv3ncdf_read(dynvars,'W','w',g_w,mype_w,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'LIQ_WAT','liq_wat',g_ql,mype_ql,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'ICE_WAT','ice_wat',g_qi,mype_qi,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'RAINWAT','rainwat',g_qr,mype_qr,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'SNOWWAT','snowwat',g_qs,mype_qs,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'GRAUPEL','graupel',g_qg,mype_qg,grd_ens%lat2,grd_ens%lon2,dual_res)
      call gsi_fv3ncdf_read(tracers,'RAIN_NC','rain_nc',g_qnr,mype_qnr,grd_ens%lat2,grd_ens%lon2,dual_res)
    else
