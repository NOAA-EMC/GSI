...
!!  tsen2tv  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (l_use_dbz_directDA ) then
      if( fv3sar_bg_opt == 0) then
        call gsi_fv3ncdf_read(dynvars,'W','w',ges_w,mype_w,lat2,lon2,.false.)
        call gsi_fv3ncdf_read(tracers,'LIQ_WAT','liq_wat',ges_ql,mype_ql,lat2,lon2,.false.)
        call gsi_fv3ncdf_read(tracers,'ICE_WAT','ice_wat',ges_qi,mype_qi,lat2,lon2,.false.)
        call gsi_fv3ncdf_read(tracers,'RAINWAT','rainwat',ges_qr,mype_qr,lat2,lon2,.false.)
        ges_iqr=ges_qr
        call gsi_fv3ncdf_read(tracers,'SNOWWAT','snowwat',ges_qs,mype_qs,lat2,lon2,.false.)
        call gsi_fv3ncdf_read(tracers,'GRAUPEL','graupel',ges_qg,mype_qg,lat2,lon2,.false.)
        call gsi_fv3ncdf_read(tracers,'RAIN_NC','rain_nc',ges_qnr,mype_qnr,lat2,lon2,.false.)
      else
