...
!     date:	 2018-08-10
!
! abstract: an obOper extension for rwNode type
!
! program history log:
...
! module interface:
  ...
  implicit none
  public:: rwOper      ! data stracture

  type,extends(obOper):: rwOper
  contains
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  character(len=*),parameter :: myname='gsi_rwOper'
  type(rwNode),save,target:: myNodeMold_
...
contains
  ...
  subroutine setup_(self, lunin, mype, is, nobs, init_pass,last_pass)
    ...
    implicit none
    class(rwOper ), intent(inout):: self
