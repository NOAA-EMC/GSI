...
!          write(*,'(a,a10,2F8.2,5(I5,2F3.0,3F8.2))') ' viirs before : ', isis,&
!                data_s(iscan_ang,n),pangs, &
!               (ich(i),varinv(i),varinv_use(i),tbc(i),tb_obs(i),tnoise(i),i=1,nchanl)
...
!          write(*,'(a,a10,2F8.2,5(I5,2F3.0,3F8.2))') ' viirs after  : ', isis,
!          &
!                data_s(iscan_ang,n),pangs, &
!               (ich(i),varinv(i),varinv_use(i),tbc(i),tb_obs(i),tnoise(i),i=1,nchanl)
