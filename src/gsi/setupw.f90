...
! !USES:
  ...
  use guess_grids, only: ges_lnprsl,comp_fact10,pt_ll,pbl_height,ges_prsl,ges_tsen
...
! Declare local variables
  ...
  real(r_kind),dimension(nsig)::prsltmp,tsentmp,qtmp,tges,zges,zges_read,uges,vges,prsltmp2
