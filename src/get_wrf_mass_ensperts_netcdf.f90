...
!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
                             ...
                             !     call compare_to_guess(cwmr,'cwmr',nsig)
...
!$$$ end documentation block
  ...
  use guess_grids, only: ntguessig,ges_u,ges_v,ges_tv,ges_q,ges_oz,ges_cwmr,ges_ps,ges_tsen,ges_prsl
  ...
  integer(i_kind) it,iderivative,i,j,k
  logical ice
