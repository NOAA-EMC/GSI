...
!                .      .    .                                       .
! subprogram:	 module gsi_qOper
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2018-08-10
!
! abstract: an obOper extension for qNode type
!
! program history log:
...
! module interface:
  ...
  implicit none
  public:: qOper      ! data stracture

  type,extends(obOper):: qOper
  contains
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  character(len=*),parameter :: myname='gsi_qOper'
