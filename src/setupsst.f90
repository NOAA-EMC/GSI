...
! Observation class
  ...
  real(r_kind),dimension(miter) :: obsdiag_iuse
           ...
           call nc_diag_metadata("Height",                  data(izob,i)           )
           call nc_diag_metadata("Time",                    dtime-time_offset      )
           call nc_diag_metadata("Prep_QC_Mark",            data(ipct,i)           )
...
!          call nc_diag_metadata("Nonlinear_QC_Var_Jb",     var_jb                 )
           ...
           call nc_diag_metadata("Observation",                   data(isst,i)     )
           call nc_diag_metadata("Obs_Minus_Forecast_adjusted",   ddiff            )
           call nc_diag_metadata("Obs_Minus_Forecast_unadjusted", data(isst,i)-sstges )
