...
!                .      .    .                                       .
! subprogram:	 module gsi_wOper
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2018-08-10
!
! abstract: an obOper extension for wNode type
!
! program history log:
...
! module interface:
  ...
  implicit none
  public:: wOper      ! data stracture

  type,extends(obOper):: wOper
  contains
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  character(len=*),parameter :: myname='gsi_wOper'
  type(wNode),save,target:: myNodeMold_
