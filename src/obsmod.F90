...
!   bias correction coefficients to this unit (iout_rad)
    ...
    iout_vis=250   ! visibility
    iout_gust=251  ! wind gusts
    iout_lag=252   ! lagrangian observations
    iout_howv=253  ! significant wave height
    iout_sst=254   ! sst
    iout_gps=255   ! gps refractivity or bending angle
    iout_pblh=256  ! pbl height
    iout_wspd10m=257 ! 10m wind speed
    iout_td2m=258  ! 2m dew point temperature
