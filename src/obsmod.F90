...
! set passed variables to public
  ...
  public :: mxtm_ob_type,mitm_ob_type,pmsl_ob_type,howv_ob_type
  ...
  public :: i_mxtm_ob_type,i_mitm_ob_type,i_pmsl_ob_type,i_howv_ob_type
  ...
  public :: mxtmtail,mxtmhead,mitmtail,mitmhead,pmsltail,pmslhead,howvtail,howvhead
...
! Declare types
  ...
  integer(i_kind),parameter:: nobs_type = 30      ! number of observation types
