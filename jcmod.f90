...
!$$$ end documentation block
  ...
  logical jcterm,jcdivt,ljcdfi
  real(r_kind) bamp_ext1,bamp_ext2,bamp_int1,bamp_int2,alphajc
...
!$$$ end documentation block
    ...
    use constants, only: one,ione,izero,zero
