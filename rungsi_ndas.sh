...
gsiexec=/global/save/wx20rt/gsi_anl/sorc/q1fy10_new/global_gsi
...
tmpdir=/ptmp/wx20rt/tmpreg_ndas_$FORMAT/$exp
savdir=/ptmp/wx20rt/outreg/ndas_$FORMAT/$exp


# Specify GSI fixed field and data directories.
fixnco=/nwprod/fix
fixjif=/global/save/wx20rt/2jif/Q1FY09_DA/fix
fixcrtm=/global/save/wx20rt/2jif/Q1FY10_DA/fix/crtm_gfs
...
prefixs=ndas.t${hha}z
suffix=tm00.bufr_d

datobs=/global/save/wx20rt/gsi_anl/cases/regional/ndas_binary/$adate
datges=$datobs
...
pcpinfo=$fixnco/global_pcpinfo.txt
ozinfo=$fixjif/global_ozinfo.txt
errtable=$fixnco/nam_errtable.r3dv
convinfo=$fixjif/global_convinfo.txt
mesonetuselist=$fixnco/nam_mesonet_uselist.txt


# Only need this file for single obs test
bufrtable=$fixnco/prepobs_prep.bufrtable
...
$ncp $datobs/${prefixa}.prepbufr.tm09.nr    ./prepbufr
$ncp $datobs/${prefixa}.1bhrs3.tm09.bufr_d  ./hirs3bufr
$ncp $datobs/${prefixa}.1bhrs4.tm09.bufr_d  ./hirs4bufr
$ncp $datobs/${prefixa}.1bamua.tm09.bufr_d  ./amsuabufr
$ncp $datobs/${prefixa}.1bamub.tm09.bufr_d  ./amsubbufr
$ncp $datobs/${prefixa}.1bmhs.tm09.bufr_d   ./mhsbufr
$ncp $datobs/${prefixa}.goesfv.tm09.bufr_d  ./gsnd1bufr
$ncp $datobs/${prefixa}.airsev.tm09.bufr_d  ./airsbufr
$ncp $datobs/${prefixa}.radwnd.tm09.bufr_d  ./radarbufr
$ncp $datobs/${prefixa}.nexrad.tm09.bufr_d  ./l2rwbufr
...
#
$ncp $datobs/${prefixa}.satbias.tm12      ./satbias_in
$ncp $datobs/${prefixa}.satang.tm12        ./satbias_angle
