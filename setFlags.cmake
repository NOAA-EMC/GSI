...
#   set(UTIL_Fortran_FLAGS "${FOPT3} ${WARNALL} ${HOST_FLAG} ${IMPLICITNONE} ${TRACEBACK} ${FP_MODEL_STRICT} ${BIG_ENDIAN} -DWRF -D_REAL8_  ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
    set(UTIL_Fortran_FLAGS "${FOPT3} ${WARNALL} ${HOST_FLAG} ${IMPLICITNONE} ${TRACEBACK} ${FP_MODEL_STRICT} ${BIG_ENDIAN} -DWRF  ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
