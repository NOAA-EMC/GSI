...
!$$$ end documentation block
  ...
  real(r_kind),intent(in),dimension(npres_print,nconvtype,5,3):: work1
  real(r_kind),intent(in),dimension(nlev):: pbot,ptop
  logical,intent(in),dimension(nconvtype)::pflag
