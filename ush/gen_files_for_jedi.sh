...
gsiexec=/scratch4/NCEPDEV/da/save/Cory.R.Martin/GSI/build_jedidiag/bin/gsi.x
nccat=/scratch4/NCEPDEV/da/save/Cory.R.Martin/GSI/build_jedidiag/bin/nc_diag_cat.x
gsiexec=/scratch4/NCEPDEV/da/save/Cory.R.Martin/GSI/build/bin/gsi.x
nccat=/scratch4/NCEPDEV/da/save/Cory.R.Martin/GSI/build/bin/nc_diag_cat.x
...
# run GSI
cd $WorkDir
nprocs_gsi=$(( $SLURM_TASKS_PER_NODE*$SLURM_JOB_NUM_NODES ))
