...
'reinit'
'open pw_stas_ges.ctl'
'open pw_stas_anl.ctl'
*'open pw_stas_int.ctl'
'set grads off'
debug=0
...
'!rm -f area.txt'
if ( iy <10)
'!cat pw_stas_ges.ctl |grep "region=  'iy' " > area.txt'
else
'!cat pw_stas_ges.ctl |grep "region= 'iy' " > area.txt'
endif
...
'!rm -f info.txt'
'!cat pw_stas_ges.ctl |grep "'ix' dtype=" > info.txt'
...
'draw string '1.1' 'ystring' pw'stype'-'subtype':'title.nf' at 'area
'set line 1 1'
...
outfile='pw'stype'-'subtype'_bias_region'iy'_lev1.png'
