...
export FIXDIR=/u/wx20es/home/convweb/fix/airthin 
...
$NCP $DATDIR/cnvstat.${PDATE} $DATDIRL/cnvstat.$PDATE
$NCP $DATDIR/pgbanl.${PDATE} $DATDIRL/pgbanl.$PDATE
$NCP $DATDIR/pgbf06.${GDATE} $DATDIRL/pgbf06.$GDATE
