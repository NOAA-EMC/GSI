...
export WEBDIR=/export/lnx42/wd20xs/gsiobr/${SUFFIX}/pngs
export EXEDIR=/u/wx20es/home/convweb/exec_200707
export FIXDIR=/u/wx20es/home/convweb/fix/${SUFFIX} 
...
#GDATDIR=/com/gfs/prod/gdas.$gsdate
...
$NCP $DATDIR/cnvstat.gdas.${PDATE} $DATDIRL/cnvstat.$PDATE
$NCP $DATDIR/pgbanl.gdas.${PDATE} $DATDIRL/pgbanl.$PDATE
$NCP $DATDIR/pgbf06.gdas.${GDATE} $DATDIRL/pgbf06.$GDATE
...
$SUB -a $ACOUNT -e $listvar -j horz_hist_${SUFFIX} -q dev -g devonprod -t 0:30:00 -o $LOGDIR/horz_hist.log $SCRIPTS/horz_hist.sh
