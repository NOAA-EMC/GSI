...
#        Major root paths
#-------------------------------------------------------------------------------
rootPath=/data/data007/pub/mirs_oper
dataPath=${rootPath}/data
binPath=${rootPath}/bin
logPath=${rootPath}/logs
IDL=/data/starfs1/compilers/idl_8.1/idl/idl81/bin/idl
...
#        External data & Paths
#-------------------------------------------------------------------------------
externalDataPath=/data/data007/pub/external_data
...
sensorId=14	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP/ATMS,7:AMSRE,8:FY3-MWRI,9:TRMM/TMI,10:GPM/GMI,12:MADRAS,13:SAPHIR,14:MetopB
...
dayUsed4Bias=2012_10_11	#Extension used to determine which bias to use in the ec process.
dayUsed4Alg=2012_10_11	#Extension used to determine which algorithms to use in the externDataFromRegress step
