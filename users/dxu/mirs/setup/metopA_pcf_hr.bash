...
maxLat=50	#Max latitude of data to be processed (only if GeogrLimits=1)
minLon=-160	#Min longitude of data to be processed (only if GeogrLimits=1)
maxLon=-115	#Max longitude of data to be processed (only if GeogrLimits=1)
