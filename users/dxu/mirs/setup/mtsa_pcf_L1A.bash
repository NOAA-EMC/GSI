...
#        Major root paths
#-------------------------------------------------------------------------------
rootPath=/disks/data006/pub/chrisg/mirs_working_mt
...
sensorId=13	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP,7:AMSRE,8:FY3-MWRI,9:TRMM/TMI,10:GPM GMI,12:MADRAS,13:SAPHIR
...
externalDataSrc=1	#Source of external Data (only if externDataAvailable=1). =1-> ANALYS, =2->REGRESS
...
useCPU=0	#0->Use one CPU; 1->Use all CPUs; 2->Use QSUB
