...
#        External data & Paths
#-------------------------------------------------------------------------------
externalDataPath=/net/orbit227l/home/pub/external_data
rdrSensor1Path=${externalDataPath}/1b/rdr/${satId}_${sensor1}_${sensor2}
rdrSensor2Path=${externalDataPath}/1b/rdr/${satId}_${sensor1}_${sensor2}
rdrOrbitPath=${externalDataPath}/rdr/OrbitalMode
nwpGdasGridPath=${externalDataPath}/gdas
nwpEcmwfGridPath=/disk1/pub/external_data/ecmwf
...
sensorId=2	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP,7:AMSRE,8:FY3-MWRI,9:TRMM/TMI
outFMAccuracy=1	#Flag to output of the FM accuracy metric (DeltaTB @89)
...
dayUsed4Bias=2006_11_01	#Extension used to determine which bias to use in the ec process.
dayUsed4Alg=2006_11_01	#Extension used to determine which algorithms to use in the externDataFromRegress step
...
email=Wanchun.Chen@noaa.gov,Kevin.Garrett@noaa.gov	#comma separated email addresses to notify
