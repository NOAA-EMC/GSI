...
minLat=17	#Min latitude of data to be processed (only if GeogrLimits=1)
maxLat=32	#Max latitude of data to be processed (only if GeogrLimits=1)
minLon=-98	#Min longitude of data to be processed (only if GeogrLimits=1)
maxLon=-68	#Max longitude of data to be processed (only if GeogrLimits=1)
