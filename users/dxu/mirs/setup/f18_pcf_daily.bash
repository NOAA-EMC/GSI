...
dataPath=/disk1/pub/mirs_operational/data
binPath=${rootPath}/bin
logPath=/disk1/pub/mirs_operational/logs
...
#        External data & Paths
#-------------------------------------------------------------------------------
externalDataPath=/home/pub/external_data
rdrSensor1Path=${externalDataPath}/1b/rdr/${satId}_${sensor1}
rdrOrbitPath=${externalDataPath}/rdr/OrbitalMode
nwpGdasGridPath=${externalDataPath}/gdas
nwpEcmwfGridPath=${externalDataPath}/ecmwf
nwpGfsGridPath=${externalDataPath}/gfs
...
biasPath=${dataPath}/SemiStaticData/biasCorrec
...
ncPath=${testbedDataPath}/Outputs/nc/${satId}_${sensor1}
...
step_nc=0	#Convert EDR & DEP into NETCDF4 format
...
sensorId=5	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP,7:AMSRE,8:FY3-MWRI,9:TRMM/TMI
...
fmType=0	#POES/NPP:0(low),1(high); DMSP:0(UAS-lowest),1(LAS),2(ENV),3(IMG-highest); TRMM:-1(coarse),0(low),1(high)
...
nwpEcmwfUse=1	#=1->To Use ECMWF in NWP Collocation, =0-> Not Use ECMWF
...
dayUsed4Bias=2008_03_06	#Extension used to determine which bias to use in the ec process.
dayUsed4Alg=2008_03_06	#Extension used to determine which algorithms to use in the externDataFromRegress step
nOrbits2Process=1000000	#Number of orbits/suborbits to process: overwrites the existing number of orbits
tdrFormat=0	#Format of TDR (depends on the RDR decoder at hand):0->ascii, 1->binary
gifDensity=100	#density used when converting PS files into Gif images
gridFactor=2	#grid factor used when gridding level III data
...
email=Kevin.Garrett@noaa.gov,Wanchun.Chen@noaa.gov	#comma separated email addresses to notify
website=http://www.star.nesdis.noaa.gov/corp/scsb/mirs/dataquality.php	#website address to view result
