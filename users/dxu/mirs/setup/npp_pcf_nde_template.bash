...
sensor2=dummy
date=2006-11-01
working_directory=/net/orbit267l/home/pub/kgarrett/d20111208_t2355490_e2356206
#-------------------------------------------------------------------------------
#        Major root paths
#-------------------------------------------------------------------------------
rootPath=/home/pub/kgarrett/mirs_2nde
dataPath=${working_directory}
binPath=${rootPath}/bin
logPath=${dataPath}
IDL=/usr/local/bin/idl
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/intel/composerxe-2011.2.137/lib/intel64	#OS dependent(HP is SHLIB_PATH; AIX is LIBPATH; Linux is ID_LIBRARAY_PATH)
...
step_bufr=0	#CONVERT INTO BUFR FORMAT
...
sensorId=6	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:NPP,7:AMSRE,8:FY3-MWRI,9:TRMM/TMI
rdrType=1       #For NPP ATMS 1:Use TDR   3:Use SDR (SDRs always needed for NEDT estimate regardless of flag value)
...
fmType=1	#POES/NPP:0(low),1(high); DMSP:0(UAS-lowest),1(LAS),2(ENV),3(IMG-highest); TRMM:-1(coarse),0(low),1(high)
...
nScanLineSensor2Skip=1	#Number of sensor1 scan lines to skip upfront (to accomodate geolocation issues) 
...
email=Wanchun.Chen@noaa.gov	#comma separated email addresses to notify
