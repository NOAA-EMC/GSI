...
#        Major root paths
#-------------------------------------------------------------------------------
rootPath=/data/data006/pub/wchen/mirs_v9_r3230
...
sensorId=14	#1:N18,2:MetopA,3:F16,4:N19,5:F18,6:ATMS,7:AMSRE,8:FY3/MWRI,9:TMI,10:GMI,12:MADRAS,13:SAPHIR,14:MetopB,15:AMSR2
...
fmType=1	#POES/NPP:0(low),1(high); DMSP:0(UAS-low),1(LAS),2(ENV),3(IMG-high); TMI/AMSR2:-1(coarse),0(low),1(high)
...
nScanLineSensor2Skip=2	#Number of sensor 2 scan lines to skip upfront (to accomodate geolocation issues) 
