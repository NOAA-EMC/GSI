 ...
 *---------------------------------------------------*/
   fread(&hblock1, L_HBLOCK1, 1, amb1bs);

/*---------------------------------------------------*
 * Skip the second block of header 
 *---------------------------------------------------*/

   fseek(amb1bs, L_HBLOCK2, SEEK_CUR);

/*---------------------------------------------------*
 * Read the third block of header
 *---------------------------------------------------*/

   fread(&hblock3, L_HBLOCK3, 1, amb1bs);
   
/*---------------------------------------------------*
 * Read the fourth block of header
 *---------------------------------------------------*/

   fread(&hblock4, L_HBLOCK4, 1, amb1bs);


/*---------------------------------------------------*
 * Skip the rest bytes in the header record
 *---------------------------------------------------*/
   left_rec = REC_LENGTH_B - L_HBLOCK1  - L_HBLOCK2
                           - L_HBLOCK3 - L_HBLOCK4;
