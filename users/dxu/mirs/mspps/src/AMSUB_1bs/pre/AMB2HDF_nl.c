 ...
 *  Type              : Main program
 *  Function          : Program reads NOAA-16 AMSU-B 1B* data, computes 
 ...
 *                      read_latbox_table.c, read_mask.c, ramb_whdfeos.c
 *  Called by         : None
 *
...
int main()
{
   ...
   char        *string2[] = { "ORBITAL", "DAILY",
                             "PENTAD",  "MONTHLY" };
   char         input_fname[] = "../data/NOAA-L/input/input_B.dat";
 ...
 *---------------------------------------------------*/
   if((fp_FNAME=fopen("../data/NOAA-L/misc/amsubfile_nl","r")) == NULL)
   {
