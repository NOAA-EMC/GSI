...
int main()
{
   ...
   char         input_fname[] = "../data/NOAA-K/input/input_prod_B.dat";
   ...
   char     	snamefile_A[50]="../data/NOAA-K/misc/swath_A_nk.list";
   char     	snamefile_B[50]="../data/NOAA-K/misc/swath_B_nk.list";
