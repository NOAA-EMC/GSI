...
int main()
{
   ...
   char         input_fname[] = "../data/NOAA-L/input/input_prod_B.dat";
   ...
   char         iwp_s_fname[] = "../data/control/iwp_s_table.dat";

   char     	snamefile_A[50]="../data/NOAA-L/misc/swath_A_nl.list";
   char     	snamefile_B[50]="../data/NOAA-L/misc/swath_B_nl.list";

/*---------------------------------------*
 * Initialize load_indx
 *---------------------------------------*/
   load_indx = 0;
