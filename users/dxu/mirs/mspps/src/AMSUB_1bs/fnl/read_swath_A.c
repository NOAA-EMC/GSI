 ...
 *                      SWATH_N16_AMSUA_Syyddd_sttttt_Eyyddd_ettttt.hdf
 ...
 *--------------------------------*/
   ...
   printf("read_swath_A/HDF file id  %d,  SWATH id %d\n", sfid, sid);


   dimsize[0] = SWdiminfo(sid, "Scanline");
   printf("read_swath_A/Scanline %6d  \n", dimsize[0]);
   *nscan = dimsize[0];
