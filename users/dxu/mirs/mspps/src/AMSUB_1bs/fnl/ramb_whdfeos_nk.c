 ...
 *   01/13/2006         Changed for the new OPUS structures   jzhao (QSS)
 ***********************************************************************/
...
void ramb_whdfeos(FILE *fp_FNAME_A, FILE *fp_FNAME_B)
{
   ...
   char            direct_swath_A[]="../data/NOAA-K/output/swath/";
   char            direct_swath_B[]="../data/NOAA-K/tmp/";
   char            direct_bin_out[]="../data/NOAA-K/output/biny/";
