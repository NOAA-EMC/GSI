...
int main()
{
   ...
   char        *string2[] = { "ORBITAL", "DAILY",
                             "PENTAD",  "MONTHLY" };
   char        input_fname[] = "../data/NOAA-K/input/input_A.dat";
   char        corr_fname[] = "../data/NOAA-K/input/corr_para_A.dat"; 
   char        latbox_fname[] = "../data/NOAA-K/input/latbox_table_A.dat"; 
 ...
 *---------------------------------------------------*/
   if((fp_FNAME=fopen("../data/NOAA-K/misc/amsuafile_nk","r")) == NULL)
   {
     printf("AMA2HDF/Can't open AMA1BS filename file: amsuafile_nk!\n");
     exit(1);
   }
   printf("AMA2HDF/Successfully open AMA1BS filename file: amsuafile_nk !\n");
