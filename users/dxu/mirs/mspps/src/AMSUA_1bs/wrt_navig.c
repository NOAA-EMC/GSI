 ...
 *  Input Files       : None
 *  Output Files      : SWATH_N16_AMSUA_Syyddd_sttttt_Eyyddd_ettttt.hdf
...
long int wrt_navig(long int sw_id)
{
      ...
      semimajor_axis = hblock4.semimajor_axis;
      eccentricity = hblock4.eccentricity;
      inclination =hblock4.inclination ;
      argument_of_perigee =hblock4.argument_of_perigee ;
      right_ascension = hblock4.right_ascension;
      mean_anomaly = hblock4.mean_anomaly;
