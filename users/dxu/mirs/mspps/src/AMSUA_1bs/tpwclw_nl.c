...
/*   #define  kv23  4.80423e-3 * 1.14 / 1.05 */
   ...
   #define  coe1_a -2.2682
   #define  coe1_b -2.7575
   #define  coe1_c 3.064293419
   #define  coe1_d -1.844769074
   #define  coe1_e 1.100935855
   #define  coe1_f 2.573123026

   #define  coe2_a 44.7
   #define  coe2_b -73.142
   #define  coe2_c 27.95998241
   #define  coe2_d -2.699010169
   #define  coe2_e 1.116107868
   #define  coe2_f 4.454987186

   #define  coe3_a 35.984
   #define  coe3_b -79.406
   #define  coe3_c 37.87657236
   #define  coe3_d -3.907292323
   #define  coe3_e 1.20336045
   #define  coe3_f 3.959459873
