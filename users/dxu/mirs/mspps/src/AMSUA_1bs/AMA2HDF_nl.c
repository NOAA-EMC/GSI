...
int main()
{
   ...
   char        *string2[] = { "ORBITAL", "DAILY",
                             "PENTAD",  "MONTHLY" };
   char        input_fname[] = "../data/NOAA-L/input/input_A.dat";
   char        corr_fname[] = "../data/NOAA-L/input/corr_para_A.dat"; 
   char        latbox_fname[] = "../data/NOAA-L/input/latbox_table_A.dat"; 
 ...
 *---------------------------------------------------*/
   if((fp_FNAME=fopen("../data/NOAA-L/misc/amsuafile_nl","r")) == NULL)
   {
     printf("AMA2HDF/Can't open AMA1BS filename file: amsuafile_nl !\n");
     exit(1);
   }
   printf("AMA2HDF/Successfully open AMA1BS filename file: amsuafile_nl !\n");
