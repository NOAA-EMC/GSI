...
extern float64    	time_tai93[MAXSCANLINE_A];
...
extern short int   	count[NUMCHAN_A][NUMSPOT_A];

extern float 		at[MAXSCANLINE_A][NUMSPOT_A][NUMCHAN_A];
extern float		ssmi_r[SSMI_LON][SSMI_LAT];
...
extern short int 	i_ssmi,j_ssmi;
...
extern SCANLINE1   scanline1[MAXSCANLINE_A];
extern SCANLINE2   scanline2[MAXSCANLINE_A];
extern SCANLINE3   scanline3[MAXSCANLINE_A];
