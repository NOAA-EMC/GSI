...
data  kv/5.277882e-03,1.924828e-03,3.200650e-03,9.528114e-03,3.594270e-02,1.642366e-01/ ! mhs frequencies: 89,157,183.31+/-1,183.31+/-3,190.31
...
data  (ko2_coe(5,i),i=1,3)/3.467140e-02, -1.225669e-04,  1.024226e-07/
data  (ko2_coe(6,i),i=1,3)/1.787196e-02, -6.553724e-05,  5.574552e-08/
...
!
  ...
  data (coe(1,k),k=1,6)/6.01145e-01, 3.56027e+01, 1.05234e+01, -1.96573e-03, -8.16731e-03, 9.04567e-05/
  data (coe(2,k),k=1,6)/-1.54766e+00, 5.97618e+01, 7.82266e+00, 6.13072e-08, 3.16810e-03, -2.20356e-04/
  data (coe(3,k),k=1,6)/3.58784e+00, 6.94517e+01, 2.03055e+01, -1.03393e-02, -1.65070e-03, 4.94207e-04/
  data (coe(4,k),k=1,6)/-3.40500e+00, 6.31635e+01, 1.56417e+01, 9.80019e-04, 2.39442e-02, 5.05712e-04/
  data (coe(5,k),k=1,6)/-6.61659e-01, -1.06035e+01, 1.85508e+01, 5.61938e-01, -1.52686e-03, -7.55941e-05/
  data (coe(6,k),k=1,6)/2.64038e-01, -3.85973e+01, 8.65209e-01, -3.43425e-09, -2.03502e-05, 9.79771e-06/
...
! Remove bias between obo and onelayerRTM
 ...
 data (coe(1,k),k=1,ncoe)/-5.440482e+00,  3.093601e-02, -2.806206e-02,  1.558352e-02, -7.505296e-03,  3.661060e-05,  1.022892e-02/
 data (coe(2,k),k=1,ncoe)/-7.355245e+00,  4.541667e-02, -2.469197e-02,  7.792155e-03, -1.065580e-02,  4.602781e-03,  5.588538e-03/
 data (coe(3,k),k=1,ncoe)/-4.461119e+01,  1.965664e-01, -1.630086e-01,  1.658950e-01, -2.029187e-02,  3.265005e-03, -1.376648e-02/
 data (coe(4,k),k=1,ncoe)/-8.134727e+00,  6.812387e-02, -5.031436e-02, -6.947955e-03,  1.099334e-03,  2.026060e-02, -1.201827e-03/
 data (coe(5,k),k=1,ncoe)/-4.059310e+00,  8.666236e-02, -9.688026e-02,  4.488369e-02, -5.399159e-02,  5.856322e-02, -2.151328e-02/
 data (coe(6,k),k=1,ncoe)/2.311404e+01,  1.641581e-02,  1.038203e-01, -3.212699e-01,  2.881256e-02, -2.640455e-01,  3.452711e-01/
