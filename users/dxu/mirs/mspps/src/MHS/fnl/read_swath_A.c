 ...
 *                      SWATH_MP1_AMSUA_Syyddd_sttttt_Eyyddd_ettttt.hdf
 ...
 *     ------     ---------       ------------------------
 *   10/31/2000      v2.0
 *   11/28/2001      v2.1        Add code to read 89 GHz for new snow 
 *                               algorithm
 *   11/02/2007                  Add reading time for granule start check jz
  ***********************************************************************/
 ...
 * Read Time fields
 *--------------------------------*/
   status = SWreadfield(sid, "Time", NULL, NULL, NULL, time_A);
   result = result + status;
