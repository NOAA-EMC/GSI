 ...
 *  Type              : Subroutine
 *  Function          : Program writes geolocation fields to HDF_EOS 
 *			swath file
 *  Input Files       : None
...
/****************************************************************/
long int wrt_geo(long int sw_id, TOTNUM_OF_SCAN  numscan) 
{ 

   double    toolkit_td(char *);
...
/*-----------------------------------------------*
 * Generate edges and geolocation arrays 
 *-----------------------------------------------*/
   edges[0] = numscan;
   edges[1] = NUMSPOT_M;
