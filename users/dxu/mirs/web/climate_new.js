...
var satellite_npp_adv  = new satellite_object("npp", "mirs_", "clw em(23v:31v:50h:51h:52h:53h:54h1:54h2:55h:57h1:57h2:57h3:57h4:57h5:57h6:88v:165h:183h1:183h2:183h3:183h4:183h5) gs iwp lwp rr rwp sfc(cyl:pn:ps) sice(cyl:pn:ps) sicefy(cyl:pn:ps) sicemy(cyl:pn:ps) snow(cyl:pn:ps) swe(cyl:pn:ps) tbc(23v:31v:50h:51h:52h:53h:54h1:54h2:55h:57h1:57h2:57h3:57h4:57h5:57h6:88v:165h:183h1:183h2:183h3:183h4:183h5) tbu(23v:31v:50h:51h:52h:53h:54h1:54h2:55h:57h1:57h2:57h3:57h4:57h5:57h6:88v:165h:183h1:183h2:183h3:183h4:183h5) temp(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb) tpw ts wv(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb)");

var satellite_list = new Array( satellite_n18_her,satellite_n18_adv,satellite_metopA_her,satellite_metopA_adv,satellite_f16_adv,satellite_n19_her, satellite_n19_adv,satellite_f18_adv,satellite_trmm_adv,satellite_npp_adv ); 
...
function changeSatellite( satval, layerID ) {
	...
	var alg_obj   = document.form1.alg ;
    	...
    	if( satval == "f16" || satval == "f18" || satval == "trmm" || satval == "npp" ) {
	...
	if( year == 2008 ) {
		...
		FIRST_MONTH = 0;
		if( sat == 'n19' ) FIRST_MONTH = 1;
		else		   FIRST_MONTH = 0; 
		LAST_MONTH  = 11;

		FIRST_PEN = 0;
		if( sat == 'n19' ) FIRST_PEN = 9;
		else               FIRST_PEN = 0;
		LAST_PEN  = 72;

		FIRST_WEEK = 0;
		if( sat == 'n19' ) FIRST_WEEK = 7;
		else               FIRST_WEEK = 0;
		LAST_WEEK  = 52;
	}
	else if( year == 2010 ) {
		...
		FIRST_MONTH = 0;
		if( sat == 'f18' ) FIRST_MONTH = 1;
		else		   FIRST_MONTH = 0;
		
		LAST_MONTH  = 11;
		
		FIRST_PEN = 0;
		if( sat == 'f18' ) FIRST_PEN = 10;
		else		   FIRST_PEN = 0;
		
		LAST_PEN  = 72;

		FIRST_WEEK = 0;
		LAST_WEEK  = Math.floor( (JDAY_NOW+2) / 7 ) - 1;
	}
	
	else if( year == 2011 ) {
	
		FIRST_MONTH = 0;
		if( sat == 'npp' ) FIRST_MONTH = 10;
		else		   FIRST_MONTH = 0;
		
		LAST_MONTH  = MONTH_NOW-1;
		if( LAST_MONTH < 0 ) LAST_MONTH=0;
		
		FIRST_PEN = 0;
		if( sat == 'npp' ) FIRST_PEN = 64;
		else if ( sat == 'trmm' ) FIRST_PEN = 63;
		else		   FIRST_PEN = 0;
		
		LAST_PEN  = Math.floor( (JDAY_NOW-1) / 5 ) - 1;
		if( LAST_PEN < 0 ) LAST_PEN = 0 ;
...
function changeSatellite2( satval, layerID ) { 
    ...
    if( sat2 == "f16" || sat2 == "f18" || satval == "trmm" || satval == "npp" ) {
	...
	if( year2 == 2008 ) {
		...
		FIRST_MONTH = 0;
		if( sat2 == 'n19' ) FIRST_MONTH = 1;
		LAST_MONTH  = 11;

		FIRST_PEN = 0; 
		if( sat2 == 'n19' ) FIRST_PEN = 9;
		LAST_PEN  = 72;

		FIRST_WEEK = 0;
		if( sat2 == 'n19' ) FIRST_WEEK = 7;
		LAST_WEEK  = 52;
	}
	else if( year2 == 2010 ) {
		...
		FIRST_PEN = 0;
		if( sat2 == 'npp' ) FIRST_PEN = 64;
		else if( sat2 == 'trmm' ) FIRST_PEN = 63;
		else		   FIRST_PEN = 0;
...
function changeAlg( algVal )
{
	...
	if( alg == "mspps_" ) {
		...
		document.form1.sat.options[1].value = "metopA";
		document.form1.sat.options[1].text  = "METOP-A";
		document.form1.sat.options[2] = new Option();
		document.form1.sat.options[2].value = "n19";
		document.form1.sat.options[2].text  = "NOAA-19";
	}
	else {
		document.form1.sat.options.length=0;
		document.form1.sat.options[0] = new Option();
		...
		document.form1.sat.options[3].value = "f16";
		document.form1.sat.options[3].text  = "F16 SSMIS";
		document.form1.sat.options[4] = new Option();
		document.form1.sat.options[4].value = "f18";
		document.form1.sat.options[4].text  = "F18 SSMIS";
		
		document.form1.sat.options[5] = new Option();
		document.form1.sat.options[5].value = "trmm";
		document.form1.sat.options[5].text  = "TRMM TMI";
...
function changeAlg2( algVal )
{
	...
	if( alg2 == "mspps_" ) {
		...
		document.form1.sat2.options[1].value = "metopA";
		document.form1.sat2.options[1].text  = "METOP-A";
		document.form1.sat2.options[2] = new Option();
		document.form1.sat2.options[2].value = "n19";
		document.form1.sat2.options[2].text  = "NOAA-19";
	}
	else {
		document.form1.sat2.options.length=0;
		document.form1.sat2.options[0] = new Option();
		...
		document.form1.sat2.options[3].value = "f16";
		document.form1.sat2.options[3].text  = "F16 SSMIS";
		document.form1.sat2.options[4] = new Option();
		document.form1.sat2.options[4].value = "f18";
		document.form1.sat2.options[4].text  = "F18 SSMIS";
		
		document.form1.sat2.options[5] = new Option();
		document.form1.sat2.options[5].value = "trmm";
		document.form1.sat2.options[5].text  = "TRMM TMI";
		
		document.form1.sat2.options[6] = new Option();
		document.form1.sat2.options[6].value = "npp";
		document.form1.sat2.options[6].text  = "NPP ATMS";
	}
...
function loadImages() 
{
  ...
  { 
	...
	if ( prod == "em" || prod == "temp" || prod == "wv" || prod == "tbc" || prod == "tbu" 
	  || prod == "sfc" || prod == "sice" || prod == "sicemy" || prod == "sicefy" || prod == "snow" || prod == "swe" )
	{    
...
function loadImages2()
{
  ...
  { 
	...
	if ( prod2 == "em" || prod2 == "temp" || prod2 == "wv" || prod2 == "tbc" || prod2 == "tbu" 
	  || prod2 == "sfc" || prod2 == "sice" || prod2 == "sicemy" || prod2 == "sicefy" || prod2 == "snow" || prod2 == "swe" )
	{    
