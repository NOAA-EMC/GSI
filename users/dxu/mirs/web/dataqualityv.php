...
<body onLoad="initv(sat1,scale1,chan1,yr1,mo1,dy1, sat2,scale2,chan2,yr2,mo2,dy2, sat3,scale3,chan3,yr3,mo3,dy3, sat4,scale4,chan4,yr4,mo4,dy4);">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_dataqualityv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<TD align=center nowrap class="productTd" colspan=2>
				 ...
				 <B><font size=4>MIRS Data Quality Monitoring</font></B>
				</TD>
				</TR>
				...
				<select class="productSelect" id="sat1" name="sat1" onChange="changeSat(this.value,1);loadImagev(1);"  title="select a satellite sensor">
				...
				&nbsp;
				<select class="productSelect" id="scale1" name="scale1" onChange="changeScale(this.value,1);loadImagev(1);" title="select a time scale ( only NPP ATMS has daily one )">
				<option value="Life" >Sensor Life</option>
				<!--option value="daily">Daily</option-->
				</select>
				
				&nbsp; 
				<select class="productSelect" id="chan1" name="chan1" onChange="loadImagev(1);"
				...
				<select class="productSelect" id="sat2" name="sat2" onChange="changeSat(this.value,2);loadImagev(2);"  title="select a satellite sensor">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;
				<select class="productSelect" id="scale2" name="scale2" onChange="changeScale(this.value,2);loadImagev(2);" title="select a time scale ( only NPP ATMS has daily one )">
				<option value="Life" >Sensor Life</option>
				<!--option value="daily">Daily</option-->
				</select>
				
				&nbsp; 
				<select class="productSelect" id="chan2" name="chan2" onChange="loadImagev(2);" 
					title="select a parameter">
				<option value="convrate">Convergence Rate</option>   
				<option value="qc0">QC=0</option>	
				<option value="qc1">QC=1</option>	
				...
				<select class="productSelect" id="sat3" name="sat3" onChange="changeSat(this.value,3);loadImagev(3);" title="select a satellite sensor">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;
				<select class="productSelect" id="scale3" name="scale3" onChange="changeScale(this.value,3);loadImagev(3);" title="select a time scale ( only NPP ATMS has daily one )">
				<option value="Life" >Sensor Life</option>
				<!--option value="daily">Daily</option-->
				</select>
				
				&nbsp;
				<select class="productSelect" id="chan3" name="chan3" onChange="loadImagev(3);"
					title="select a parameter">
				<option value="convrate">Convergence Rate</option>   
				<option value="qc0">QC=0</option>	
				<option value="qc1">QC=1</option>	
				...
				<select class="productSelect" id="sat4" name="sat4" onChange="changeSat(this.value,4);loadImagev(4);" title="select a satellite sensor">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;
				<select class="productSelect" id="scale4" name="scale4" onChange="changeScale(this.value,4);loadImagev(4);" title="select a time scale ( only NPP ATMS has daily one )">
				<option value="Life" >Sensor Life</option>
				<!--option value="daily">Daily</option-->
				</select>
				
				&nbsp;
				<select class="productSelect" id="chan4" name="chan4" onChange="loadImagev(4);"
					title="select a parameter">
				<option value="convrate">Convergence Rate</option>   
				<option value="qc0">QC=0</option>	
				<option value="qc1">QC=1</option>	
