...
<body onLoad="loadInitialImages(prod1,layer1,cond1,yr1,mo1,dy1,prod2,layer2,cond2,yr2,mo2,dy2,prod3,layer3,cond3,yr3,mo3,dy3,prod4,layer4,cond4,yr4,mo4,dy4,prod5,layer5,cond5,yr5,mo5,dy5,prod6,layer6,cond6,yr6,mo6,dy6)" >
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_simulatev.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="simulate.php" method="post">
...
?>
				...
				<tr>
				<td class="imageContainer" id="panel2" align=center>
...
?>
				...
				<tr>
				<td class="imageContainer" id="panel3" align=center>
...
?>
				...
				<tr>
				<td class="imageContainer" id="panel4" align=center>
...
?>
				...
				<tr>
				<td class="imageContainer" id="panel5" align=center>
...
?>
				...
				<tr>
				<td class="imageContainer" id="panel6" align=center>
