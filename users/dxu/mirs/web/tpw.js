...
var satellite_metopB_adv = new satellite_object("metopB", "adv", "tpw rr");
...
var satellite_npp_adv    = new satellite_object("npp",    "adv", "tpw rr");
...
SENSORTAG["npp"]    = "mirs_adv_npoess_npp_";
SENSORTAG["metopB"] = "mirs_adv_poes_metopB_";
...
SENSORTAG["mtma"]   = "mirs_adv_mt_mtma_madras_";
SENSORTAG["mtsa"]   = "mirs_adv_mt_mtsa_saphir_";
...
// image location
var IMGDIR_ADV="temp/img_TPW_EU/";
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////
function loadImageHelper(alg,sat,prod,layer,proj,cend,sfc,region,yyyy,mm,dd,ref,cond) {
	...
	if ( alg == "her" ) {   // her, MSPPS
	  ...
	  if   	(prod == "rrday" || prod == "rrlat" ) {
	    image=IMGDIR_ADV+"ipwg/mirs_adv_poes_glb_"+yyyy+mm+dd+"_"+prod+"_all_ad.png";
  	    ...
  	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_"+sfc+"_"+cend+".png";
	  }
	  else if ( prod == "em" ) {
  	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_"+proj+sfc+"_"+cend+".png";
	    if( sat == "trmm" ) {
	      image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_"+sfc+"_"+cend+".png";
	    }
	  }
	    ...
	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_all_"+cend+".png";
	  }
	  else if ( prod == "sice" || prod == "sicefy" || prod == "sicemy" ) {
  	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_sea_"+cend+".png";
	  } 
	  else if ( prod == "swe" || prod == "snow" || prod == "gs" ) {
  	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+layer+"_lnd_"+cend+".png";
	  } 
	  else if ( prod == "emspectrum" ) {
	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+"glb"+"_"+yyyy+mm+dd+"_"+prod+"_all_"+cend+".png";
	  }
	  else if ( prod == "wspd" ) {
	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_sea_"+cend+".png";
	  }
	  else    {
  	    
	    if( ref == "gdas_bias" || ref == "ecmwf_bias" ) {
	    	image=IMGDIR_ADV+SENSORTAG[sat]+ref+'_'+region+"_"+yyyy+mm+dd+"_"+prod+"_"+cond+"_"+sfc+"_"+cend+".png";
	    }
	    else {
	    	image=IMGDIR_ADV+SENSORTAG[sat]+ref+'_'+region+"_"+yyyy+mm+dd+"_"+prod+"_"+sfc+"_"+cend+".png";	
	    }
...
function loadImage1() {
	...
	var cond1  = document.form.cond1.value;
	
	var image1 = loadImageHelper(alg1,sat1,prod1,layer1,proj1,cend1,sfc1,region1,yyyy1,mm1,dd1,ref1,cond1);
...
function loadImage2() {
	...
	var cond2  = document.form.cond2.value;
	
	var image2 = loadImageHelper(alg2,sat2,prod2,layer2,proj2,cend2,sfc2,region2,yyyy2,mm2,dd2,ref2,cond2);
...
function loadImage3() {
	...
	var cond3  = document.form.cond3.value;
	
	var image3 = loadImageHelper(alg3,sat3,prod3,layer3,proj3,cend3,sfc3,region3,yyyy3,mm3,dd3,ref3,cond3);
...
function loadImage4() {
	...
	var cond4  = document.form.cond4.value;
	
	var image4 = loadImageHelper(alg4,sat4,prod4,layer4,proj4,cend4,sfc4,region4,yyyy4,mm4,dd4,ref4,cond4);
			    ...
			    alg4,sat4,cend4,sfc4,region4,prod4,layer4,proj4,yr4,mo4,dy4 )
{
	...
	document.form.proj1.value = proj1;	
	if ( layer1 != '' ) document.form.layer1.value = layer1;
	var image1 = loadImageHelper(alg1,sat1,prod1,layer1,proj1,cend1,sfc1,region1,yr1,mo1,dy1,'amsuamhs','allcond');
	image2Obj(image1, document.form.img1, "href1"); 
	...
	var image2 = loadImageHelper(alg2,sat2,prod2,layer2,proj2,cend2,sfc2,region2,yr2,mo2,dy2,'amsuamhs','allcond');
	image2Obj(image2, document.form.img2, "href2"); 
	...
	var image3 = loadImageHelper(alg3,sat3,prod3,layer3,proj3,cend3,sfc3,region3,yr3,mo3,dy3,'amsuamhs','allcond');
	image2Obj(image3, document.form.img3, "href3"); 
	...
	var image4 = loadImageHelper(alg4,sat4,prod4,layer4,proj4,cend4,sfc4,region4,yr4,mo4,dy4,'amsuamhs','allcond');
	image2Obj(image4, document.form.img4, "href4"); 
