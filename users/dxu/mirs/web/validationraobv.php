...
<title>STAR - MIRS Project - Comparison to Radiosonde</title>
<?php
...
<script language="javascript" type="text/javascript" src="validationraob.js"></script>


</head>
<body  onLoad="loadInitialImagesv(sat,prod,layer,sfc,yr,mo,dy)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_validationraobv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="validationraob.php" method="post">

				<table border="0" cellpadding="0" cellspacing="0" class="tableGrid" bgcolor="#eeeeee">

				<TR><TD align=center bgcolor="#eeeeee" height=18>
				<input  type=submit  value="2X2/3X2 Panels" style="background-color: lightblue" > &nbsp;&nbsp;
				<B><font size=4>MIRS Comparison to Radiosonde</font></B> (<em>Click image for large view</em>)
				</TD></TR>
				...
				&nbsp;Product:
				<select name="prod" onChange="changeProductv(this.value); loadImage_top();">
				...
				<option value="tb"	>Brightness Temperature</option>
				</select>
                                
				&nbsp;
				<select id="layer" name="layer" onChange="loadImage_top();">
				...
				<TR>
				  <TD id="box7" align=center nowrap width=0 height=0>
				    <a id="href7" href="" target=_blank>
				    <img name="img7" src="" align=center width=0 height=0 alt=""></a>
				  </TD>
				</TR>

				<TR>
				  <TD id="box8" align=center nowrap width=0 height=0>
				    <a id="href8" href="" target=_blank>
				    <img name="img8" src="" align=center width=0 height=0 alt=""></a>
				  </TD>
				</TR>
				...
				&nbsp;Product:
				<select name="prod2" onChange="changeProductv(this.value); loadImage_bottom();">
				<option value="temp"   	>Temperature Profile</option>
				<option value="wv"     	>Water Vapor Profile</option>  
				<option value="tpw"    	>TPW</option>  
				<option value="em"	>Emissivity</option>
