			...
			<div class="padding" id="monitor">
				...
				<TR>
				  ...
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img2" src="" align=right width=325 height=250 alt="SNODAS collocated"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD id="box3" align=center nowrap width=325 height=275>
				    ...
				    <img name="img3" src="" align=left  width=325 height=250 alt="Bias Map"></a>
				  </TD>

				  <TD id="box4" align=center nowrap width=325 height=275>
				    <a id="href4" href="" target=_blank>
				    <img name="img4" src="" align=right width=325 height=250 alt="p2p scattered plot"></a>
				  </TD>
				</TR>


				<TR>
				  <TD id="box5"  align=center nowrap width=325 height=275 style="display:none">
