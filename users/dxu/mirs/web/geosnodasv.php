...
<title>STAR - MIRS Project - Comparison SNODAS SWE</title>
...
<script language="javascript" type="text/javascript" src="geosnodas.js"></script>

</head>
<body  onLoad="loadInitv(sat,plot,stat,prod,region,view,cend,yr,mo,dy);">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geosnodasv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geosnodas.php" method="post">
				...
				<B><font size=4>MIRS Comparison to SNODAS Snow</font></B>
				</TD></TR>

				<TR>
				<TD align=center colspan=2>

				<select name="sat" onChange="loadImagev();" title="select a satellite sensor">
				...
				&nbsp;
				<select name="plot" onChange="changePlot( this.value ); loadImagev();" title="select a plot type">
				...
				&nbsp;
				<select id="stat" name="stat" class="optioninvisible" onChange="changeStat( this.value ); loadImagev();" title="select a statistics">
				...
				<select name="region" onChange="loadImagev();" title="select a region">
				<option value="conus01" >Conus</option>
				</select>
				
				&nbsp;
				<select name="view" onChange="loadImagev();" title="select a map projection type">
				...
				&nbsp;
				<select name="cend" onChange="loadImagev();" title="select a passing mode (Asc: ascending or Des: descending)">
				<option value="as" >Asc</option>
				<option value="ds" >Des</option>
				</select>			  
				
				&nbsp;
				<select id="yr" name="yr" onChange="loadImagev();" title="select a year">
				...
				&nbsp;
				<select id="mo" name="mo" onChange="loadImagev();" title="select a month">	  
				...
				&nbsp;
				<select id="dy" name="dy" onChange="loadImagev();" title="select a day">	  
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img1" src="" align=center width=650 height=500 alt="MiRS retrieval" title=""></a>
				  </TD>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" align=center width=650 height=500 alt="SNODAS collocated"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD id="box3" align=center nowrap width=650 height=500>
				    ...
				    <img name="img3" src="" align=center width=650 height=500 alt="Bias Map"></a>
				  </TD>
				...
				<TR>
				  <TD id="box4" align=center nowrap width=650 height=500>
				    ...
				    <img name="img4" src="" align=center width=650 height=500 alt="p2p scattered plot"></a>
				  </TD>
				</TR>


				<TR>
				  <TD id="box5"  align=center nowrap width=650 height=500 style="display:none">
				    <a id="href5" href="" target=_blank>
				    <img name="img5" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				  
				</TR>

				<TR>
				  <TD id="box6"  align=center nowrap width=650 height=500 style="display:none">
				    <a id="href6" href="" target=_blank>
				    <img name="img6" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				</TR>


				<TR>
				  <TD id="box7" align=center nowrap width=650 height=500 style="display:none">
				    <a id="href7" href="" target=_blank>
				    <img name="img7" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				  
				</TR>

				<TR>
				  <TD id="box8" align=center nowrap width=650 height=500 style="display:none">
				    <a id="href8" href="" target=_blank>
				    <img name="img8" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				</TR>


				<TR>
				  <TD id="box9" align=center nowrap width=650 height=500 style="display:none">
				    <a id="href9" href="" target=_blank>
				    <img name="img9" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				  
				</TR>

				<TR>
				  <TD id="boxa" align=center nowrap width=650 height=500 style="display:none">
				    <a id="hrefa" href="" target=_blank>
				    <img name="imga" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				</TR>


				<TR>
				  <TD id="boxb" align=center nowrap width=650 height=500 style="display:none">
				    <a id="hrefb" href="" target=_blank>
				    <img name="imgb" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				  
				</TR>

				<TR>
				  <TD id="boxc" align=center nowrap width=650 height=500 style="display:none">
				    <a id="hrefc" href="" target=_blank>
				    <img name="imgc" src="" align=center width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<select name="sat2" onChange="loadImage2v();" title="select a satellite sensor">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;
				<select name="plot2" onChange="changePlot( this.value ); loadImage2v();" title="select a plot type">
				<option value="map"   >Map</option>  
				<option value="his"   >Histogram</option>   
				<option value="ts"    >Time Series</option>   
				</select>
				...
				&nbsp;
				<select id="stat2" name="stat2" class="optioninvisible" onChange="changeStat( this.value ); loadImagev();" title="select a statistics">
				<option value="hss">Heidke Skill Score			</option>
				...
				<select name="region2" onChange="loadImage2v();" title="select a region">
				<option value="conus01" >Conus</option>
				</select>
				
				&nbsp;
				<select name="view2" onChange="loadImage2v();" title="select a map projection type">
				<option value="cyl" >Cyl</option>
				</select>
				
				&nbsp;
				<select name="cend2" onChange="loadImage2v();" title="select a passing mode (Asc: ascending or Des: descending)">
				<option value="as" >Asc</option>
				<option value="ds" >Des</option>
				</select>			  
				
				&nbsp;
				<select id="yr2" name="yr2" onChange="loadImage2v();" title="select a year">
				<option value="2012">2012</option> 
				<option value="2013">2013</option>
				<option value="2014">2014</option> 
				<option value="2015">2015</option> 
				...
				&nbsp;
				<select id="mo2" name="mo2" onChange="loadImage2v();" title="select a month">	  
				<option value="01">Jan</option>
				<option value="02">Feb</option>
				<option value="03">Mar</option>
				<option value="04">Apr</option>
				...
				&nbsp;
				<select id="dy2" name="dy2" onChange="loadImage2v();" title="select a day">	  
				<option value="01">1 </option>   
				<option value="02">2 </option>   
				<option value="03">3 </option>   
				<option value="04">4 </option>   
