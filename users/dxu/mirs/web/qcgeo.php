...
<title>STAR - Microwave Integrated Retrieval System (MIRS) - QC Monitoring - Geophysical </title>
<?php
...
<script language="javascript" type="text/javascript" src="qcgeo.js"></script>
  ...
  <tr>
    <td id="navCell">
		...
		<td class="mainPanel"><a name="skipTarget"></a><?php require('includes/noScriptWarning.inc'); ?>
			...
			<h1> <center>MIRS QC Monitoring - Geophysical Bias Table</center> </h1>
