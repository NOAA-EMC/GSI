...
<body  onLoad="loadInitialImages(sat,prod,layer,cend,sfc,yr,mo,dy)">
<?php
// insert banner rows
    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geomsppsv.php" method="post">
				...
				<input  type=submit  value="6 X 1 Panel" style="background-color: lightblue" > &nbsp;&nbsp;
				<B><font size=4>MIRS Geophysical Performance Monitoring(MSPPS)</font></B> (<em>Click image for large view</em>)
				</TD></TR>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img1" src="" align=left  width=325 height=250 alt="mirs retrieval" title="mirs"></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href2" href="" target=_blank>
				    <img name="img2" src="" align=right width=325 height=250 alt="mspps"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img3" src="" align=left  width=325 height=250 alt="difference of mirs and mspps"></a>
				  </TD>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img5" src="" align=left  width=325 height=250 alt="scattered plot of mirs vs mspps"></a>
				  </TD>
