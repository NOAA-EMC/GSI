...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_radiov.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="radio.php" method="post">
				...
				<input  type=submit  value="4 X 2 Panel" style="background-color: lightblue" > &nbsp;&nbsp;
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img1" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img2" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img3" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img4" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img5" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img6" src="" width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img7" src=""  width=650 height=500 alt=""></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500 >
				    ...
				    <img name="img8" src=""  width=650 height=500 alt=""></a>
				  </TD>
				</TR>
