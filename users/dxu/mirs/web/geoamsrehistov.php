...
<title>STAR - MIRS Project - Comparison to AMSR-E Snow and Ice: Histogram</title>
...
<script language="javascript" type="text/javascript" src="geoamsrehisto.js"></script>

</head>
<body  onLoad="loadInitialImages(sat,yr,mo,dy)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geoamsrehistov.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geoamsrehistov.php" method="post">
				...
				<input  type=submit  value="4 X 2 Panels" style="background-color: lightblue" > &nbsp;&nbsp;
				<B><font size=4>MIRS Comparison to AMSR-E Snow and Ice: Histograms</font></B>
				</TD></TR>
				...
				Sensor:
				<select name="sat" onChange="loadImages();" >
				...
				&nbsp;Year:
				<select id="yr" name="yr" onChange="loadImages();">
				...
				Month:
				<select id="mo" name="mo" onChange="loadImages();">	  
				...
				Day:
				<select id="dy" name="dy" onChange="loadImages();">	  
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img1" src="" align=center  width=650 height=500 alt="" title="Global Ascending Sea Ice"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" align=center width=650 height=500 alt="" title="Global Descending Sea Ice"></a>
				  </TD>
				</TR>
				...
				Sensor:
				<select name="sat2" onChange="loadImages2();" >
				<option value="n18"	      >NOAA-18</option>
				<option value="n19"	      >NOAA-19</option>
				<option value="metopA"        >METOP-A</option>
				<option value="f16"	      >F16/SSMIS</option>
				...
				&nbsp;Year:
				<select id="yr2" name="yr2" onChange="loadImages2();">
				<option value="2000">2000</option>
				<option value="2001">2001</option> 
				<option value="2002">2002</option>
				<option value="2003">2003</option> 
				...
				Month:
				<select id="mo2" name="mo2" onChange="loadImages2();">	  
				<option value="01">Jan</option>
				<option value="02">Feb</option>
				<option value="03">Mar</option>
				<option value="04">Apr</option>
