...
<title>STAR - Microwave Integrated Retrieval System (MIRS) - QC Monitoring - Radiometric Standard Deviation Table</title>
<?php
...
<script language="javascript" type="text/javascript" src="qcstdv.js"></script>
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_qcstdv.inc');
			?>
		</td>
		<td class="mainPanel"><a name="skipTarget"></a><?php require('includes/noScriptWarning.inc'); ?>
			...
			<h1><center>MIRS QC Monitoring - Bias Stdv. Table</center></h1>

			<center>
			
			<FORM NAME=form method=POST>
			
				<input class="productInput" type=submit value="Radiometric Bias Table" title="Radiometric Bias Table"
				 	onClick="radioTable();" style="background-color: lightblue" >&nbsp;&nbsp;
			...
			<div id="stdv_table">
				...
				<div id="legend">
					...
					RCP - Right-handed Circular Polarization. <br />
					<font color="#77e7ae">green</font>: < Spec &nbsp;&nbsp; | &nbsp;&nbsp; <font color="#fc9999">red</font>: >= Spec
				</div>
