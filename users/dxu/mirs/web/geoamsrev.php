...
<body  onLoad="loadInitialImagesV(sat,prod,layer,cend,view,yr,mo,dy)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geoamsrev.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geoamsre.php" method="post">
				...
				<B><font size=4>MIRS Comparison to AMSR-E Snow and Sea Ice</font></B>
				</TD></TR>
				...
				&nbsp;Product:
				<select name="prod" onChange="changeProduct( this.value ); changeSizeV( this.value ); loadImage();"
					title="Select a product">
				<option value="swe"    >SWE</option>  
				<option value="sice"   >Sea Ice</option>   
				</select>

				<select id="layer" name="layer" class="optioninvisible" onChange="loadImage();" title="Select an algorithm">
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" align=center width=650 height=500 alt="AMSR-E"></a>
				  </TD>
				</TR>
				...
				Mode:
				<select name="cend2" onChange="loadImage_bottom();" title="Select a passing mode (Asc: ascending or Des: descending)">
				<option value="as" >Asc</option>
				<option value="ds" >Des</option>
				</select>			  
				...
				<select name="prod2" title="Select a product" 
					onChange="changeProduct( this.value ); changeSizeV( this.value ); loadImage_bottom();">
				<option value="swe"    >SWE</option>  
				<option value="sice"   >Sea Ice</option> 
				</select>

				<select id="layer2" name="layer2" class="optioninvisible" onChange="loadImage_bottom();" title="Select an algorithm">
				<option value="nt2"   >NASA Team 2</option>   
				<option value="btp"   >Bootstrap</option>  
				</select>
