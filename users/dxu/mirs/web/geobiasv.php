...
<body onLoad="loadInitialImage(sat1,prod1,param1,sfc1,nwp1, sat2,prod2,param2,sfc2,nwp2, sat3,prod3,param3,sfc3,nwp3, sat4,prod4,param4,sfc4,nwp4)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geobiasv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geobias.php" method="post">
				...
				<TD align=center nowrap class="productTd" colspan=2>
				 <input class="productInput" type=submit  value="2 X 2 Panel" style="background-color: lightblue;" 
				 	title="click this button will switch to 2 row by 2 column smaller images page view">&nbsp;&nbsp;
				...
				<TD class="productTd" id="panel1" align=center valign=top width=650 height=500 align=center>Sat
				<select class="productSelect" id="sat1" name="sat1" onChange="loadImage()" >
				...
				&nbsp;Prod
				<select class="productSelect"  id="prod1" name="prod1" onChange="loadImage()">
				<option value="temp" >Temperature</option>
				<option value="wv"   >Water Vapor</option>
				</select>
				
				&nbsp;Param
				<select class="productSelect"  id="param1" name="param1" onChange="loadImage()">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasstdv" >Bias Stdv</option>
				</select>
				
				&nbsp;Reference Data
				<select  class="productSelect" id="nwp1" name="nwp1" onChange="loadImage()">
				<option value="gdas">GDAS</option>   
				<option value="ecmwf">ECMWF</option>   
				</select>
				
				&nbsp;Surface
				<select  class="productSelect" id="sfc1" name="sfc1" onChange="loadImage()">
				...
				<input type="button" class="productInput" onClick="rev(document.form.sfc1);loadImage()" value="<=" title="previous surface type">
				<input type="button" class="productInput" onClick="fwd(document.form.sfc1);loadImage()" value="=>" title="next surface type">
				...
				<TR>
				<TD class="productTd" id="panel2" align=center valign=top width=650 height=500 align=center>Sat
				<select class="productSelect" id="sat2" name="sat2" onChange="loadImage()" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;Prod
				<select class="productSelect"  id="prod2" name="prod2" onChange="loadImage()">
				<option value="temp" >Temperature</option>
				<option value="wv"   >Water Vapor</option>
				</select>
				
				&nbsp;Param
				<select class="productSelect" id="param2" name="param2" onChange="loadImage()">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasstdv" >Bias Stdv</option>
				</select>
				
				&nbsp;Reference Data
				<select  class="productSelect" id="nwp2" name="nwp2" onChange="loadImage()">
				<option value="gdas">GDAS</option>   
				<option value="ecmwf">ECMWF</option>   
				</select>
				
				&nbsp;Surface
				<select class="productSelect" id="sfc2" name="sfc2" onChange="loadImage()">
				<option value="sea">Sea</option>   
				<option value="lnd">Land</option>   
				<option value="ice">Ice</option>   
				<option value="snw">Snow</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sfc2);loadImage()" value="<=" title="previous surface type">
				<input type="button" class="productInput" onClick="fwd(document.form.sfc2);loadImage()" value="=>" title="next surface type">
				...
				<TD class="productTd" id="panel3" align=center valign=top width=650 height=500 align=center>Sat
				<select class="productSelect" id="sat3" name="sat3" onChange="loadImage()" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;Prod
				<select class="productSelect"  id="prod3" name="prod3" onChange="loadImage()">
				<option value="temp" >Temperature</option>
				<option value="wv"   >Water Vapor</option>
				</select>
				
				&nbsp;Param
				<select class="productSelect" id="param3" name="param3" onChange="loadImage()">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasstdv" >Bias Stdv</option>
				</select>

				&nbsp;Reference Data
				<select  class="productSelect" id="nwp3" name="nwp3" onChange="loadImage()">
				<option value="gdas">GDAS</option>   
				<option value="ecmwf">ECMWF</option>   
				</select>
				
				&nbsp;Surface
				<select class="productSelect" id="sfc3" name="sfc3" onChange="loadImage()">
				<option value="sea">Sea</option>   
				<option value="lnd">Land</option>   
				<option value="ice">Ice</option>   
				<option value="snw">Snow</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sfc3);loadImage()" value="<=" title="previous surface type">
				<input type="button" class="productInput" onClick="fwd(document.form.sfc3);loadImage()" value="=>" title="next surface type">
				...
				<TR>
				<TD class="productTd" id="panel4" align=center valign=top width=650 height=500 align=center>Sat
				<select class="productSelect" id="sat4" name="sat4" onChange="loadImage()" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				&nbsp;Prod
				<select class="productSelect"  id="prod4" name="prod4" onChange="loadImage()">
				<option value="temp" >Temperature</option>
				<option value="wv"   >Water Vapor</option>
				</select>
				
				&nbsp;Param
				<select class="productSelect" id="param4" name="param4" onChange="loadImage()">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasstdv" >Bias Stdv</option>
				</select>
				
				&nbsp;Reference Data
				<select  class="productSelect" id="nwp4" name="nwp4" onChange="loadImage()">
				<option value="gdas">GDAS</option>   
				<option value="ecmwf">ECMWF</option>   
				</select>
				
				&nbsp;Surface
				<select  class="productSelect" id="sfc4" name="sfc4" onChange="loadImage()">
				<option value="sea">Sea</option>   
				<option value="lnd">Land</option>   
				<option value="ice">Ice</option>   
				<option value="snw">Snow</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sfc4);loadImage()" value="<=" title="previous surface type">
				<input type="button" class="productInput" onClick="fwd(document.form.sfc4);loadImage()" value="=>" title="next surface type">
				<br>
