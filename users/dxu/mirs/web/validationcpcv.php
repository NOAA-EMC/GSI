...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_validationcpcv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<TR><TD align=center bgcolor="#eeeeee" height=10>
				<input  type=submit  value="Time Series"  title="Go to Time Series Page" onClick="changePanel(1)" style="background-color: lightblue;"> &nbsp;&nbsp;
				<input  type=submit  value="2 X 2 Panel"  title="2 x 2 small view panel" onClick="changePanel(2)" style="background-color: lightblue;"> &nbsp;&nbsp;
				<B><font size=4>MIRS Comparison to CPC</font></B>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img1" src="" align=center  width=650 height=500 alt="" title=""></a>
				  </TD>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" align=center width=650 height=500 alt="" title=""></a>
				  </TD>
				</TR>
