...
<body  onLoad="loadInitialImages(sat,prod,layer,sfc,yr,mo,dy)">
<?php
// insert banner rows
    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="validationraobv.php" method="post">
				...
				<input  type=submit  value="Vertical Panels" style="background-color: lightblue" > &nbsp;&nbsp;
