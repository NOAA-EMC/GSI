...
function getProductText( val ) {
  ...
  else if 	( val=="sice" )   	txt = "Sea Ice Concentr." ;
  ...
  else if 	( val=="sfc" )   	txt = "Pre-Classified Sfc Type" ;
	...
	if ( alg == "her" ) {   // her, MSPPS
	  ...
	  if   	(prod == "rrday" || prod == "rrlat" ) {
	    ...
	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_sea_"+cend+".png";
  	    ...
  	    image=IMGDIR_ADV+sat+"/"+ymd+"/mirs_"+alg+SENSORTAG[sat]+region+"_"+yyyy+mm+dd+"_"+prod+"_"+sfc+"_"+cend+".png";
	  }
