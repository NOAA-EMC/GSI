...
<title>STAR - Microwave Integrated Retrieval System (MIRS) - QC Monitoring - Inter-Comparison </title>
<?php
...
<script language="javascript" type="text/javascript" src="qcinter.js"></script>
  ...
  <tr>
    <td id="navCell">
		...
		<td class="mainPanel"><a name="skipTarget"></a><?php require('includes/noScriptWarning.inc'); ?>
			...
			<h1> <center>MIRS QC Monitoring - Inter-Comparison Table</center> </h1>
			
			<center>
			<FORM NAME=form method=POST>
				
				Reference Data:<select id="ref" name="ref" title="Select a Reference Data" onChange="loadTable();">
