...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geossmisv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geossmis.php" method="post">
				...
				<B><font size=4>MIRS Comparison to SSMIS Sea Ice</font></B>
				</TD></TR>
				...
				&nbsp;
				<select id="stat" name="stat" class="optioninvisible" onChange="changeStat( this.value ); loadImagev();" title="select a stat to be the first one">
				...
				<select id="region" name="region" class="optioninvisible" onChange="loadImagev();" title="select a region">
				...
				&nbsp;
				<select id="view" name="view" onChange="loadImagev();" title="select a map projection type">
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" align=center width=650 height=500 alt="SSMIS collocated"></a>
				  </TD>
				</TR>
				...
				<select id="region2" name="region2" class="optioninvisible" onChange="loadImage2v();" title="select a region">
				<option value="glb" >Globe</option>
				<option value="nh"  >N. Hemi.</option>
				<option value="sh"  >S. Hemi.</option>
				</select>
				...
				&nbsp;
				<select id="view2" name="view2" onChange="loadImage2v();" title="select a map projection type">
				<option value="cyl" >Cyl</option>
				<option value="pn"  >PN</option>
				<option value="ps"  >PS</option>
				</select>
