...
<body  onLoad="loadInitialImagesv(sat,prod,sfc,yr,mo,dy,cend)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_validationtrmm2a12v.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<input  type=submit  value="2 X 2 Panels"    onClick="changePanel(2)" title="2 X 2 Layout"      style="background-color: lightblue;"> &nbsp;&nbsp;
...
?>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img1" src="" align=center  width=650 height=500 alt="all region" title="all surfaces"></a>
				  </TD>
				</TR>
