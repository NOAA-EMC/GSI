...
<title>STAR - MIRS Project - Geophysical Performance Monitoring (NWP)</title>
...
<body  onLoad="loadInitialImages(ref,sat,prod,layer,cond,cend,sfc,yr,mo,dy)">
<?php
// insert banner rows
    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geonwpv.php" method="post">
				...
				<B><font size=4>MIRS Geophysical Performance Monitoring (NWP)</font></B> (<em>Click image for large view</em>)
				</TD></TR>
				...
				<br>
				NWP:
				<select id="ref" name="ref" size=1
					onChange="changeRef(this.value); loadImage();" title="select a reference data set">
				...
				&nbsp;Product:
				<select name="prod" onChange="changeProd( this.value ); changeSize(this.value); loadImage();" 
					title="select a product">
				<option value="tpw"   >TPW</option> 
				<option value="tskin" >Skin Temp.</option>
				<option value="psfc"  >Sfc Pressure</option>
				<option value="em"    >Emissivity</option>   
				<option value="temp"  >Temp. Profile</option>
				<option value="wv"    >Water Vapor Profile</option>
				</select>

				<select id="layer" name="layer" class="optioninvisible" 
					onChange="changeLayer( this.value ); loadImage();" title="select a channel/layer">
				</select>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img1" src="" align=left width=325 height=250 alt="mirs retrieval" title="mirs retrieval"></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href2" href="" target=_blank>
				    <img name="img2" src="" align=right width=325 height=250 alt="nwp"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img3" src="" align=left width=325 height=250 alt="difference of mirs and nwp"></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href4" href="" target=_blank>
				    <img name="img4" src="" align=right width=325 height=250 alt="asymmetry of difference"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img5" src="" align=left width=325 height=250 alt="scattered plot of mirs vs nwp"></a>
				  </TD>
				...
				<TR>
				  <TD id="box9" align=center nowrap width=325 height=275>
				    ...
				    <img name="img9" src="" align=left width=325 height=250 alt=""></a>
				  </TD>
				  
				  <TD id="boxa" align=center nowrap width=325 height=275>
				    <a id="hrefa" href="" target=_blank>
				    <img name="imga" src="" align=right width=325 height=250 alt=""></a>
				  </TD>
				...
				<select id="ref2" name="ref2"
					onChange="changeRef(this.value); loadImage_bottom();" title="select a reference data set">
					<OPTION value="gdas"	> GDAS </OPTION>
					<OPTION value="ecmwf"	> ECMWF </OPTION>
				</select>				
				...
				<select name="prod2" title="select a product"  
					onChange="changeProd( this.value ); changeSize( this.value ); loadImage_bottom();">
				<option value="tpw"   >TPW</option> 
				<option value="tskin" >Skin Temp.</option>
				<option value="psfc"  >Sfc Pressure</option>
				<option value="em"    >Emissivity</option>   
				...
				<select id="layer2" name="layer2" class="optioninvisible" onChange="changeLayer(this.value); loadImage_bottom();"
