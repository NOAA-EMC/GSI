...
<body onLoad="loadInitialImageSmall(ref1,sat1,param1,chan1, ref2,sat2,param2,chan2, ref3,sat3,param3,chan3, ref4,sat4,param4,chan4)">
<?php
// insert banner rows
    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="radiobiasv.php" method="post">
				...
				<TD align=center nowrap class="productTd" colspan=2>
				 <input class="productInput" type=submit  value="4 X 1 Panel" style="background-color: lightblue;">&nbsp;&nbsp;
				 <B><font size=4>MIRS Radiometric Bias Monitoring </font></B> (<em>Click image for large view</em>)
				</TD>
				</TR>
				...
				<select class="productSelect" id="ref1" name="ref1" onChange="changeRef( this.value ); loadImageSmall();" title="Select a NWP reference data set">
				...
				<select class="productSelect" id="sat1" name="sat1" title="select a satellite"
				        onChange="changeSensor(this.value,document.form.chan1);loadImageSmall()" >
				<option value="n18"    >N18</option>
				<option value="n19"    >N19</option>
				<option value="metopA" >MetopA</option>
				<option value="metopB" >MetopB</option>
				<option value="f16"    >F16</option>
				<option value="f18"    >F18</option>
				<option value="npp"    >NPP</option>
				</select>

				<select class="productSelect"  id="param1" name="param1" onChange="loadImageSmall()" title="select a paramter">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasslope" >Bias Slope</option>
				<option value="biasintercept" >Bias Intp.</option>				
				<option value="tbSimu" >Sim. TB</option>				
				<option value="tbMeas" >Meas. TB</option>				
				<option value="stdv" >Std Dev</option>				
				</select>
				
				<select  class="productSelect" id="chan1" name="chan1" onChange="loadImageSmall()" title="select a channel">
				...
				<input type="button" class="productInput" onClick="rev(document.form.sat1.value,document.form.chan1);loadImageSmall();" value="<" title="previous channel">
				<input type="button" class="productInput" onClick="fwd(document.form.sat1.value,document.form.chan1);loadImageSmall();" value=">" title="next channel">
				...
				<select class="productSelect" id="ref2" name="ref2" onChange="changeRef( this.value ); loadImageSmall();" title="Select a NWP reference data set">
				<option value="gdas"  >GDAS</option>
				<option value="ecmw"  >ECMWF</option>
				<!--option value="gfs"   >GFS</option-->
				</select>			  
				...
				<select class="productSelect" id="sat2" name="sat2" title="select a satellite"
				        onChange="changeSensor(this.value,document.form.chan2);loadImageSmall()" >
				<option value="n18"    >N18</option>
				<option value="n19"    >N19</option>
				<option value="metopA" >MetopA</option>
				<option value="metopB" >MetopB</option>
				...
				<select class="productSelect" id="param2" name="param2" onChange="loadImageSmall()" title="select a paramter">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasslope" >Bias Slope</option>
				<option value="biasintercept" >Bias Intp.</option>				
				<option value="tbSimu" >Sim. TB</option>				
				...
				<select class="productSelect" id="chan2" name="chan2" onChange="loadImageSmall()" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sat2.value,document.form.chan2);loadImageSmall();" value="<" title="previous channel">
				<input type="button" class="productInput" onClick="fwd(document.form.sat2.value,document.form.chan2);loadImageSmall();" value=">" title="next channel">
				...
				<select class="productSelect" id="ref3" name="ref3" onChange="changeRef( this.value ); loadImageSmall();" title="Select a NWP reference data set">
				<option value="gdas"  >GDAS</option>
				<option value="ecmw"  >ECMWF</option>
				<!--option value="gfs"   >GFS</option-->
				</select>			  
				...
				<select class="productSelect" id="sat3" name="sat3" title="select a satellite" 
					onChange="changeSensor(this.value,document.form.chan3);loadImageSmall()" >
				<option value="n18"    >N18</option>
				<option value="n19"    >N19</option>
				<option value="metopA" >MetopA</option>
				<option value="metopB" >MetopB</option>
				...
				<select class="productSelect" id="param3" name="param3" onChange="loadImageSmall()" title="select a paramter">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasslope" >Bias Slope</option>
				<option value="biasintercept" >Bias Intp.</option>				
				<option value="tbSimu" >Sim. TB</option>				
				...
				<select class="productSelect" id="chan3" name="chan3" onChange="loadImageSmall()" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sat3.value,document.form.chan3);loadImageSmall();" value="<" title="previous channel">
				<input type="button" class="productInput" onClick="fwd(document.form.sat3.value,document.form.chan3);loadImageSmall();" value=">" title="next channel">
				...
				<select class="productSelect" id="ref4" name="ref4" onChange="changeRef( this.value ); loadImageSmall();" title="Select a NWP reference data set">
				<option value="gdas"  >GDAS</option>
				<option value="ecmw"  >ECMWF</option>
				<!--option value="gfs"   >GFS</option-->
				</select>			  
				...
				<select class="productSelect" id="sat4" name="sat4" title="select a satellite"
				   	onChange="changeSensor(this.value,document.form.chan4);loadImageSmall()" >
				<option value="n18"    >N18</option>
				<option value="n19"    >N19</option>
				<option value="metopA" >MetopA</option>
				<option value="metopB" >MetopB</option>
				...
				<select class="productSelect" id="param4" name="param4" onChange="loadImageSmall()" title="select a paramter">
				<option value="biasmean" >Bias Mean</option>
				<option value="biasslope" >Bias Slope</option>
				<option value="biasintercept" >Bias Intp.</option>				
				<option value="tbSimu" >Sim. TB</option>		
				...
				<select  class="productSelect" id="chan4" name="chan4" onChange="loadImageSmall()" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<input type="button" class="productInput" onClick="rev(document.form.sat4.value,document.form.chan4);loadImageSmall();" value="<" title="previous channel">
				<input type="button" class="productInput" onClick="fwd(document.form.sat4.value,document.form.chan4);loadImageSmall();" value=">" title="next channel">
				<br>
