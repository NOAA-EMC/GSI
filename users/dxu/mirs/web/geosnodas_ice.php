...
<title>STAR - MIRS Project - Comparison to Snow Data Assimilation System (SNODAS) Data Products at NSIDC</title>
...
if(isset($_POST['lay']))   { $lay   = $_POST['lay'];   }
...
<body  onLoad="loadInit(sat,plot,stat,prod,lay,region,view,cend,yr,mo,dy);">
<?php
// insert banner rows
    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="geosnodasv.php" method="post">
				...
				<B><font size=4>MIRS Comparison to SNODAS Snow</font></B> (<em>Click image for large view</em>)
				</TD></TR>
				...
				&nbsp;
				<select id="stat" name="stat" class="optioninvisible" onChange="changeStat( this.value ); loadImage();" title="select a statistics">
				...
				&nbsp;
				<select id="lay" name="lay" class="optioninvisible" onChange="loadImage();" title="select an algorithm">
				...
				<select name="region" onChange="loadImage();" title="select a region">
				<option value="conus01" >Conus01</option>
				</select>
				
				&nbsp;
				<select name="view" onChange="loadImage();" title="select a map projection type">
				<option value="cyl" >Cylinder</option>
				<option value="pn"  >N. H.</option>
				</select>
				...
				<TR>
				  <TD id="boxb" align=center nowrap width=325 height=275>
				    ...
				    <img name="imgb" src="" align=left width=325 height=250 alt=""></a>
				  </TD>
				  
				  <TD id="boxc" align=center nowrap width=325 height=275>
				    <a id="hrefc" href="" target=_blank>
				    <img name="imgc" src="" align=right width=325 height=250 alt=""></a>
				  </TD>
				</TR>
				...
				&nbsp;
				<select name="plot2" onChange="changePlot( this.value ); loadImage2();" title="select a image type">
				<option value="map"   >Map</option>  
				<option value="his"   >Histogram</option>   
				<option value="ts"    >Time Series</option>   
				</select>
				...
				&nbsp;Product:
				<select name="prod2" onChange="changeProduct( this.value ); changeSize( this.value ); loadImage2();" title="select a product">
				<option value="swe"    >SWE</option>  
				<option value="sice"   >Sea Ice</option>   
				</select>

				
				<select id="lay2" name="lay2" class="optioninvisible" onChange="loadImage2();" title="select an algorithm">
				<option value="nt2"   >NASA Team 2 </option>   
				<option value="btp"   >Bootstrap </option>  
				</select>
				...
				<select name="region2" onChange="loadImage2();" title="select a region">
				<option value="conus01" >Conus01</option>
				</select>
				
				&nbsp;
				View:
				<select name="view2" onChange="loadImage2();" title="select a map projection type">
