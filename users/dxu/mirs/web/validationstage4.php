...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_validationstage4.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<input  type=submit  value="Vertical Panels"  onClick="changePanel(3)" style="background-color: lightblue;"> &nbsp;&nbsp;
...
?>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img1" src="" align=left  width=325 height=250 ></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href2" href="" target=_blank>
				    <img name="img2" src="" align=right width=325 height=250 ></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD id="box3" align=center nowrap width=325 height=275>
				    ...
				    <img name="img3" src="" align=left  width=325 height=250 ></a>
				  </TD>
				  
				  <TD id="box4" align=center nowrap width=325 height=275>
				    <a id="href4" href="" target=_blank>
				    <img name="img4" src="" align=right  width=325 height=250 ></a>
				  </TD>
				...
				<TR>
				  <TD id="box5" align=center nowrap width=325 height=275>
				    ...
				    <img name="img5" src="" align=left  width=325 height=250 ></a>
				  </TD>
				  
				  <TD id="box6" align=center nowrap width=325 height=275>
				    <a id="href6" href="" target=_blank>
				    <img name="img6" src="" align=right  width=325 height=250 ></a>
				  </TD>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img7" src="" align=left  width=325 height=250 ></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href8" href="" target=_blank>
				    <img name="img8" src="" align=right width=325 height=250 ></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img9" src="" align=left  width=325 height=250 ></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="hrefa" href="" target=_blank>
				    <img name="imga" src="" align=right width=325 height=250 ></a>
				  </TD>
				</TR>
