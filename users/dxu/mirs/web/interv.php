...
<body  onLoad="interv_init(data1,sat1,prod1,lay1,cend1,sfc1,yr1,mo1,dy1)">
<?php
// insert banner rows
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_interv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<input  type=submit  value="2 Columns Panel" style="background-color: lightblue;"
					title="2 columns / row page format with smaller images view"> &nbsp;&nbsp;
				<B><font size=4>MIRS Inter-Comparison Monitoring</font></B>
				</TD></TR>

				<TR title="comparison is done based on gridded data set values">
				<TD align=center>
				...
				<select name="prod1" title="Select a product"
					onChange="changeProd1( this.value ); changeSizeV( this.value ); loadImage1();">
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img1" src="" width=650 height=500 align=center alt="NOAA-18" title="NOAA-18"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img2" src="" width=650 height=500 align=center alt="NOAA-19" title="NOAA-19"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img3" src="" width=650 height=500 align=center alt="N18 - N19"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img5" src="" width=650 height=500 align=center alt="sea/land scattered plot"></a>
				  </TD>
				</TR>
				...
				<TR>
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="img6" src="" width=650 height=500 align=center alt="ice/snow scattered plot"></a>
				  </TD>
				</TR>
				...
				<TR id="boxb">
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="imgb" src="" width=650 height=500 align=center alt=""></a>
				  </TD>
				</TR>
				...
				<TR id="boxc">
				  <TD align=center nowrap width=650 height=500>
				    ...
				    <img name="imgc" src="" width=650 height=500 align=center alt=""></a>
				  </TD>
				</TR>
