...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_nedtv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				Sensor
				<select class="productSelect" id="sat1" name="sat1" title="select a satellite sensor" onChange="changeSat(this.value,1);loadImagev(1);" >
				...
				Time Scale
				<select class="productSelect" id="scale1" name="scale1" onChange="changeScale(this.value,1);loadImagev(1);" title="select a time scale">
				...
				&nbsp; Channel
				<select class="productSelect" id="chan1" name="chan1" onChange="loadImagev(1);" title="select a channel">
				...
				<option value="20">20:190h</option>  	  
			        ...
			        <input type="button" class="productInput" onclick="rev(1);loadImagev(1);" value="<=" title="previous channel">
                                <input type="button" class="productInput" onclick="fwd(1);loadImagev(1);" value="=>" title="next channel">
				
				<br>
				
				<select class="optioninvisible" id="yr1" name="yr1" title="select a year"  onChange="loadImagev(1);">
				...
				<select class="optioninvisible" id="mo1" name="mo1" title="select a month" onChange="loadImagev(1);">
				...
				<select class="optioninvisible" id="dy1" name="dy1" title="select a day" onChange="loadImagev(1);">
				...
				<input id="prev1" class="inputinvisible" type="button" onclick="prev(1);loadImagev(1);" title="previous day image" value="<=">
				<input id="next1" class="inputinvisible" type="button" onclick="next(1);loadImagev(1);" title="next day image" value="=>">
				...
				Sensor
				<select class="productSelect" id="sat2" name="sat2" title="select a satellite sensor" onChange="changeSat(this.value,2);loadImagev(2);" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				Time Scale
				<select class="productSelect" id="scale2" name="scale2" onChange="changeScale(this.value,2);loadImagev(2);" title="select a time scale">
				<option value="Life" >Sensor Life</option>
				<option value="Month">30-day</option>
				<!--option value="Daily">1-day</option-->
				</select>
				...
				&nbsp;Channel
				<select class="productSelect" id="chan2" name="chan2" onChange="loadImagev(2);" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<option value="20">20:190h</option>  	  
			        ...
			        <input type="button" class="productInput" onclick="rev(2);loadImagev(2);" value="<=" title="previous channel">
                                <input type="button" class="productInput" onclick="fwd(2);loadImagev(2);" value="=>" title="next channel">

				<br>
				
				<select class="optioninvisible" id="yr2" name="yr2" title="select a year"  onChange="loadImagev(2);">
                                <option value="2011">2011</option> 
                                <option value="2012">2012</option> 
                                <option value="2013">2013</option> 
                                <option value="2014">2014</option> 
				...
				<select class="optioninvisible" id="mo2" name="mo2" title="select a month" onChange="loadImagev(2);">
                                <option value="01">Jan</option>
                                <option value="02">Feb</option>
                                <option value="03">Mar</option>
                                <option value="04">Apr</option>
				...
				<select class="optioninvisible" id="dy2" name="dy2" title="select a day" onChange="loadImagev(2);">
				<option value="01">1</option>
                                <option value="02">2</option>
                                <option value="03">3</option>
                                <option value="04">4</option>
				...
				<input id="prev2" class="inputinvisible" type="button" onclick="prev(2);loadImagev(2);" title="previous day image" value="<=">
				<input id="next2" class="inputinvisible" type="button" onclick="next(2);loadImagev(2);" title="next day image" value="=>">
				...
				Sensor
				<select class="productSelect" id="sat3" name="sat3" title="select a satellite sensor" onChange="changeSat(this.value,3);loadImagev(3);" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				Time Scale
				<select class="productSelect" id="scale3" name="scale3" onChange="changeScale(this.value,3);loadImagev(3);" title="select a time scale">
				<option value="Life" >Sensor Life</option>
				<option value="Month">30-day</option>
				<!--option value="Daily">1-day</option-->
				</select>
				...
				&nbsp; Channel
				<select class="productSelect" id="chan3" name="chan3" onChange="loadImagev(3);" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<option value="20">20:190h</option>  	  
			        ...
			        <input type="button" class="productInput" onclick="rev(3);loadImagev(3);" value="<=" title="previous channel">
                                <input type="button" class="productInput" onclick="fwd(3);loadImagev(3);" value="=>" title="next channel">

				<br>
				
				<select class="optioninvisible" id="yr3" name="yr3" title="select a year"  onChange="loadImagev(3);">
                                <option value="2011">2011</option> 
                                <option value="2012">2012</option> 
                                <option value="2013">2013</option> 
                                <option value="2014">2014</option> 
				...
				<select class="optioninvisible" id="mo3" name="mo3" title="select a month" onChange="loadImagev(3);">
                                <option value="01">Jan</option>
                                <option value="02">Feb</option>
                                <option value="03">Mar</option>
                                <option value="04">Apr</option>
				...
				<select class="optioninvisible" id="dy3" name="dy3" title="select a day" onChange="loadImagev(3);">
				<option value="01">1</option>
                                <option value="02">2</option>
                                <option value="03">3</option>
                                <option value="04">4</option>
				...
				<input id="prev3" class="inputinvisible" type="button" onclick="prev(3);loadImagev(3);" title="previous day image" value="<=">
				<input id="next3" class="inputinvisible" type="button" onclick="next(3);loadImagev(3);" title="next day image" value="=>">
				...
				Sensor
				<select class="productSelect" id="sat4" name="sat4" title="select a satellite sensor" onChange="changeSat(this.value,4);loadImagev(4);" >
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="metopB" >METOP-B</option>
				...
				Time Scale
				<select class="productSelect" id="scale4" name="scale4" onChange="changeScale(this.value,4);loadImagev(4);" title="select a time scale">
				<option value="Life" >Sensor Life</option>
				<option value="Month">30-day</option>
				<!--option value="Daily">1-day</option-->
				</select>
				...
				&nbsp; Channel
				<select class="productSelect" id="chan4" name="chan4" onChange="loadImagev(4);" title="select a channel">
				<option value="1">1:23v</option>   
				<option value="2">2:31v</option>   
				<option value="3">3:50v</option>   
				<option value="4">4:52v</option>   
				...
				<option value="20">20:190h</option>  	  
			        ...
			        <input type="button" class="productInput" onclick="rev(4);loadImagev(4);" value="<=" title="previous channel">
                                <input type="button" class="productInput" onclick="fwd(4);loadImagev(4);" value="=>" title="next channel">

				<br>
				
				<select class="optioninvisible" id="yr4" name="yr4" title="select a year"  onChange="loadImagev(4);">
                                <option value="2011">2011</option> 
                                <option value="2012">2012</option> 
                                <option value="2013">2013</option> 
                                <option value="2014">2014</option> 
				...
				<select class="optioninvisible" id="mo4" name="mo4" title="select a month" onChange="loadImagev(4);">
                                <option value="01">Jan</option>
                                <option value="02">Feb</option>
                                <option value="03">Mar</option>
                                <option value="04">Apr</option>
				...
				<select class="optioninvisible" id="dy4" name="dy4" title="select a day" onChange="loadImagev(4);">
				<option value="01">1</option>
                                <option value="02">2</option>
                                <option value="03">3</option>
                                <option value="04">4</option>
				...
				<input id="prev4" class="inputinvisible" type="button" onclick="prev(4);loadImagev(4);" title="previous day image" value="<=">
				<input id="next4" class="inputinvisible" type="button" onclick="next(4);loadImagev(4);" title="next day image" value="=>">
