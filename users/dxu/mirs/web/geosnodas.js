...
function changePlot( plotval ) 
{
	...
	if( plotval == "ts" ) {
		...
		// add all sensor 
		document.form.sat.options[6] = new Option();
		document.form.sat.options[6].value = "allSensors";
		document.form.sat.options[6].text = "All Sensors";
		
		document.form.sat2.options[6] = new Option();
		document.form.sat2.options[6].value = "allSensors";
		document.form.sat2.options[6].text = "All Sensors";
		...
		document.form.sat.options.length = 6;
		document.form.sat2.options.length = 6;
...
function loadImageHelp(sat1,plot1,stat1,prod1,region1,view1,cend1,yr1,mo1,dy1) {
	...
	if ( plot1 == "map" ) {
		img1 = imgDir+sat1+ymd1+header+sat1+dash+sensor+region1+"_nongrid_"+yr1+mo1+dy1+dash+prod1+dash+view1+dash+sfc1+dash+cend1+".png";
  		img2 = imgDir+sat1+ymd1+header+sat1+"_snodas_conus01_nongrid_"+yr1+mo1+dy1+dash+prod1+dash+view1+dash+sfc1+dash+cend1+".png";
  		img3 = imgDir+sat1+ymd1+header+sat1+"_snodas_bias_conus01_nongrid_"+yr1+mo1+dy1+dash+prod1+dash+view1+dash+sfc1+dash+cend1+".png";
  		img4 = imgDir+sat1+ymd1+header+sat1+"_snodas_conus01_p2p_"+yr1+mo1+dy1+dash+prod1+dash+sfc1+dash+cend1+".png";
	}
	else if ( plot1 == "his" ) {
		img1 = imgDir+sat1+ymd1+header+sat1+"_snodas_histo_conus01_nongrid_"+yr1+mo1+dy1+dash+prod1+dash+sfc1+"_as.png";
  		img2 = imgDir+sat1+ymd1+header+sat1+"_snodas_histo_conus01_nongrid_"+yr1+mo1+dy1+dash+prod1+dash+sfc1+"_ds.png";

	}
	else if ( plot1 == "ts" ) {
		
		img1 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+stat1+dash+cend1+".png";
		img1_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+stat1+dash+cend1+"_big.png";
		...
		img2 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[0] +dash+cend1+".png";
		img3 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[1] +dash+cend1+".png";
  		img4 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[2] +dash+cend1+".png";
		img5 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[3] +dash+cend1+".png";
  		img6 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[4] +dash+cend1+".png";
		img7 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[5] +dash+cend1+".png";
  		img8 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[6] +dash+cend1+".png";
		img9 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[7] +dash+cend1+".png";
  		imga = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[8] +dash+cend1+".png";
		imgb = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[9] +dash+cend1+".png";
  		imgc = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[10]+dash+cend1+".png";
		
		img2_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[0]+dash+cend1+"_big.png";
		img3_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[1]+dash+cend1+"_big.png";
  		img4_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[2]+dash+cend1+"_big.png";
		img5_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[3]+dash+cend1+"_big.png";
  		img6_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[4]+dash+cend1+"_big.png";
		img7_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[5]+dash+cend1+"_big.png";
  		img8_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[6]+dash+cend1+"_big.png";
		img9_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[7]+dash+cend1+"_big.png";
  		imga_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[8]+dash+cend1+"_big.png";
		imgb_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[9]+dash+cend1+"_big.png";
  		imgc_big = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[10]+dash+cend1+"_big.png";
	}
...
function loadImageHelpv(sat1,plot1,stat1,prod1,region1,view1,cend1,yr1,mo1,dy1) {
	...
	if ( plot1 == "map" ) {
		...
		img1 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+stat1+dash+cend1+"_big.png";
		...
		img2 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[0]+dash+cend1+"_big.png";
		img3 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[1]+dash+cend1+"_big.png";
  		img4 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[2]+dash+cend1+"_big.png";
		img5 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[3]+dash+cend1+"_big.png";
  		img6 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[4]+dash+cend1+"_big.png";
		img7 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[5]+dash+cend1+"_big.png";
  		img8 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[6]+dash+cend1+"_big.png";
		img9 = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[7]+dash+cend1+"_big.png";
  		imga = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[8]+dash+cend1+"_big.png";
		imgb = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[9]+dash+cend1+"_big.png";
  		imgc = imgDir+sat1+'/timeseries/scores_'+sat1+"_snodas_swe_daily_"+region1+dash+values_tmp[10]+dash+cend1+"_big.png";
	}
