			...
			<div class="padding" id="monitor">
				...
				<td class="productTd" colspan="2">
				  <input class="productInput" type="submit" value="1 Panel"      
				  	 onClick="changePanel(1);" title="One Panel for Larger View" 
					 style="background-color: lightblue;">&nbsp;&nbsp;
				  <input class="productInput" type="submit" value="4 X 1 Panel" 
				  	 onClick="changePanel(4);" title="Vertical 4 Row by 1 Column Page View with larger images" 
					 style="background-color: lightblue;">&nbsp;&nbsp;
				  <span class="productTitle">MIRS Low Resolution Products</span>
				  <input class="productInput" type="button" style="background-color: lightblue" 
				  	onclick="launchAnimation();" value="Start Animation" title="Start Latest One Month Images Loop">&nbsp;&nbsp;
				  <input class="productInput" type="button" style="background-color: lightblue;" 
				  	onclick="stopAnimation();"  value="Stop Animation" title="Stop Images Loop"><br />
					
					<!--b id="note" style="display:none;">
					<font color=red size=2>Note: some special note concering the sensor</font>
					</b> 
					<br /-->
				</td>
				</tr>
				...
				<select 
					class="productSelect" id="alg1" name="alg1" 
				...
				<select class="productSelect" id="region1" name="region1" 
...
?>
				...
				<select class="productSelect" id="region2" name="region2" 
					title="choose a region"
					onChange="loadImage2();">
					<option value="glb">Globe</option>
					<option value="us">USA</option>
				...
				<br />
				Product	<select class="productSelect" id="prod2" name="prod2" 
					title="choose a product"
...
?>
				...
				<img name="img2" src="<?php echo $img2 ?>" 
					alt="<?php echo $img2 ?>" 
					width="325" height="250" /></a></fieldset></td>
				</tr>
				...
				<select class="productSelect" id="region3" name="region3" 
					title="choose a region"
					onChange="loadImage3();">
					<option value="glb">Globe</option>
					<option value="us">USA</option>
				...
				Product	<select class="productSelect" id="prod3" name="prod3" 
					title="choose a product"
...
?>
				...
				Date	<select class="productSelect" id="yr3" name="yr3"
					title="select year"
					onChange="loadImage3();">
<?php
// year options
...
?>
				...
				<select class="productSelect" id="region4" name="region4" 
					title="choose a region"
					onChange="loadImage4();">
					<option value="glb">Globe</option>
					<option value="us">USA</option>
				...
				<br />
				Product <select class="productSelect" id="prod4" name="prod4" 
					title="choose a product"
...
2?>
				...
				Date	<select class="productSelect" id="yr4" name="yr4"
				title="select year"
				onChange="loadImage4();">
<?php
// year options
