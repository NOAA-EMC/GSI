    ...
    <td id="navCell">
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<input  type=submit  value="8 X 1 Panels" style="background-color: lightblue" > &nbsp;&nbsp;
				...
				<TR>
				  <TD align=center nowrap width=325 height=275>
				    ...
				    <img name="img1" src="" align=left  width=325 height=250 alt="" title="Global Ascending Sea Ice"></a>
				  </TD>

				  <TD align=center nowrap width=325 height=275>
				    <a id="href2" href="" target=_blank>
				    <img name="img2" src="" align=right width=325 height=250 alt="" title="Global Descending Sea Ice"></a>
				  </TD>
				</TR>
