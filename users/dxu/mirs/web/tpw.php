...
$IMGDIR_ADV="temp/img_TPW_EU/";
$IMGDIR_HER="/corp/scsb/mspps/GIFs/";

$SENSORTAG = array( 
		    "metopB" => "mirs_adv_poes_metopB_",
		    "npp"    => "mirs_adv_npoess_npp_");
...
$img1=$IMGDIR_ADV."/".$SENSORTAG[$sat1].$region1."_".$yyyy.$mm.$dd."_".$prod1."_".$sfc1."_".$cend1.".png";
...
$img2=$IMGDIR_ADV.$SENSORTAG[$sat2].$region2."_".$yyyy.$mm.$dd."_".$prod2."_".$sfc2."_".$cend2.".png";
...
$img3=$IMGDIR_ADV.$SENSORTAG[$sat3].$region3."_".$yyyy.$mm.$dd."_".$prod3."_".$layer3."_".$sfc3."_".$cend3.".png";
...
$img4=$IMGDIR_ADV.$SENSORTAG[$sat4].$region4."_".$yyyy.$mm.$dd."_".$prod4."_".$layer4."_".$sfc4."_".$cend4.".png";
...
<script language="javascript" type="text/javascript" src="tpw.js"> </script>
...
<select 
	...
	<option value="npp">ATMS</option>
	<option value="metopB">MetopB</option>
</select>

<select disabled id="alg1" name="alg1" 
...
<select disabled id="region1" name="region1" 
...
<?php
// product options
require('includes/PRODUCT_OPTS_tpw.inc');
?>
</select>

<select id="ref1" name="ref1" class="optionvisible" onChange="loadImage1();" 
	title="choose Senor_ITself/GDAS/ECMWF">
	<option value="amsuamhs" >Sensor Itself</option>
	<option value="gdas">GDAS</option>
	<option value="gdas_bias">GDAS Bias</option>
	<option value="ecmwf">ECMWF</option>
	<option value="ecmwf_bias">ECMWF Bias</option>
</select>

<select id="cond1" name="cond1" class="optionvisible" onChange="loadImage1();" 
	title="choose weather condition, only for NWP bias">
	<option value="allcond">All Weather</option>
...
<?php
// year options
require('includes/yearOptions_tpw.inc');
?>
</select>			  
...
<?php
// month options
require('includes/monthOptions_tpw.inc');
?>
</select>			  
...
<?php
// day options
require('includes/dayOptions_tpw.inc');
?>
</select>
...
<select disabled id="alg2" name="alg2" 
	title="choose an algorithm" 
	onChange="changeSatellite_template( document.form.alg2, document.form.sat2, document.form.prod2, document.form.layer2, document.form.proj2, 'layer2', 'proj2', '2' ); loadImage2();">
	<option value="adv">MIRS</option>
</select>
...
<select disabled id="region2" name="region2" 
	title="choose a region"
	onChange="loadImage2();">
	<option value="eu">Europe</option>
</select>
...
<select id="ref2" name="ref2" class="optionvisible" onChange="loadImage2();" 
	title="choose Senor_ITself/GDAS/ECMWF">
	<option value="amsuamhs" >Sensor Itself</option>
	<option value="gdas">GDAS</option>
	<option value="gdas_bias">GDAS Bias</option>
...
<select id="cond2" name="cond2" class="optionvisible" onChange="loadImage2();" 
	title="choose weather condition, only for NWP bias">
	<option value="allcond">All Weather</option>
	<option value="clear">Clear</option>
	<option value="cloudy">Cloudy</option>
...
<select disabled id="alg3" name="alg3"
	title="choose an algorithm"  
	onChange="changeSatellite_template( document.form.alg3, document.form.sat3, document.form.prod3, document.form.layer3, document.form.proj3, 'layer3', 'proj3', '3' ); loadImage3();">
	<option value="adv">MIRS</option>
</select>
...
<select disabled id="region3" name="region3" 
	title="choose a region"
	onChange="loadImage3();">
	<option value="eu">Europe</option>
</select>
...
<select id="ref3" name="ref3" class="optionvisible" onChange="loadImage3();" 
	title="choose Senor_ITself/GDAS/ECMWF">
	<option value="amsuamhs" >Sensor Itself</option>
	<option value="gdas">GDAS</option>
	<option value="gdas_bias">GDAS Bias</option>
...
<select id="cond3" name="cond3" class="optionvisible" onChange="loadImage3();" 
	title="choose weather condition, only for NWP bias">
	<option value="allcond">All Weather</option>
	<option value="clear">Clear</option>
	<option value="cloudy">Cloudy</option>
...
<select disabled id="alg4" name="alg4" 
	title="choose an algorithm" 
	onChange="changeSatellite_template( document.form.alg4, document.form.sat4, document.form.prod4, document.form.layer4, document.form.proj4, 'layer4', 'proj4', '4' ); loadImage4();">
	<option value="adv">MIRS</option>
</select>
...
<select disabled id="region4" name="region4" 
	title="choose a region"
	onChange="loadImage4();">
	<option value="eu">Europe</option>
</select>
...
<select id="ref4" name="ref4" class="optionvisible" onChange="loadImage4();" 
	title="choose Senor_ITself/GDAS/ECMWF">
	<option value="amsuamhs" >Sensor Itself</option>
	<option value="gdas">GDAS</option>
	<option value="gdas_bias">GDAS Bias</option>
...
<select id="cond4" name="cond4" class="optionvisible" onChange="loadImage4();" 
	title="choose weather condition, only for NWP bias">
	<option value="allcond">All Weather</option>
	<option value="clear">Clear</option>
	<option value="cloudy">Cloudy</option>
