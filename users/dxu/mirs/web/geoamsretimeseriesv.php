...
<body onLoad="loadInitialImagesV(sat1,parameter1,cend1,region1,prod1,layer1,
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_geoamsretimeseriesv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM name=form action="geoamsretimeseries.php" method="post">
				...
				<TD align=center nowrap class="productTd" colspan=2>
				 <input class="productInput" type=submit  value="3 X 2 Panel" style="background-color: lightblue" >&nbsp;&nbsp;
				...
				onChange="loadImageV(document.form.sat1,document.form.parameter1,document.form.cend1,document.form.region1,document.form.prod1,document.form.layer1,document.form.img1,'href1');">
				...
				onChange="changeProduct(this, 'layer1');loadImageV(document.form.sat1,document.form.parameter1,document.form.cend1,document.form.region1,document.form.prod1,document.form.layer1,document.form.img1,'href1');">
				...
				onChange="loadImageV(document.form.sat2,document.form.parameter2,document.form.cend2,document.form.region2,document.form.prod2,document.form.layer2,document.form.img2,'href2');">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="f16"    >F16/SSMIS</option>
				...
				onChange="changeProduct(this, 'layer2');loadImageV(document.form.sat2,document.form.parameter2,document.form.cend2,document.form.region2,document.form.prod2,document.form.layer2,document.form.img2,'href2');">
 				<option value="sic"   >Sea Ice </option>   
				<option value="swe"   >SWE </option>  
				</select>
				...
				onChange="loadImageV(document.form.sat3,document.form.parameter3,document.form.cend3,document.form.region3,document.form.prod3,document.form.layer3,document.form.img3,'href3');">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="f16"    >F16/SSMIS</option>
				...
				onChange="changeProduct(this, 'layer3');loadImageV(document.form.sat3,document.form.parameter3,document.form.cend3,document.form.region3,document.form.prod3,document.form.layer3,document.form.img3,'href3');">
 				<option value="sic"   >Sea Ice </option>   
				<option value="swe"   >SWE </option>  
				</select>
				...
				onChange="loadImageV(document.form.sat4,document.form.parameter4,document.form.cend4,document.form.region4,document.form.prod4,document.form.layer4,document.form.img4,'href4');">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="f16"    >F16/SSMIS</option>
				...
				onChange="changeProduct(this, 'layer4');loadImageV(document.form.sat4,document.form.parameter4,document.form.cend4,document.form.region4,document.form.prod4,document.form.layer4,document.form.img4,'href4');">
 				<option value="sic"   >Sea Ice </option>   
				<option value="swe"   >SWE </option>  
				</select>
				...
				<TR>
				<TD class="productTd" id="panel5" align=center valign=top width=650 height=500 align=center>
				
				<select class="productSelect" id="sat5" name="sat5"
				onChange="loadImageV(document.form.sat5,document.form.parameter5,document.form.cend5,document.form.region5,document.form.prod5,document.form.layer5,document.form.img5,'href5');">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="f16"    >F16/SSMIS</option>
				...
				onChange="changeProduct(this, 'layer5');loadImageV(document.form.sat5,document.form.parameter5,document.form.cend5,document.form.region5,document.form.prod5,document.form.layer5,document.form.img5,'href5');">
 				<option value="sic"   >Sea Ice </option>   
				<option value="swe"   >SWE </option>  
				</select>
				...
				<img name="img5" src=""  alt=""  width=650 height=500 ></a>
				
				</TD>
				</TR>

				<TR>
				<TD class="productTd" id="panel6" align=center valign=top width=650 height=500 align=center>
				
				<select class="productSelect" id="sat6" name="sat6"
				onChange="loadImageV(document.form.sat6,document.form.parameter6,document.form.cend6,document.form.region6,document.form.prod6,document.form.layer6,document.form.img6,'href6');">
				<option value="n18"    >NOAA-18</option>
				<option value="n19"    >NOAA-19</option>
				<option value="metopA" >METOP-A</option>
				<option value="f16"    >F16/SSMIS</option>
				...
				onChange="changeProduct(this, 'layer6');loadImageV(document.form.sat6,document.form.parameter6,document.form.cend6,document.form.region6,document.form.prod6,document.form.layer6,document.form.img6,'href6');">
 				<option value="sic"   >Sea Ice </option>   
				<option value="swe"   >SWE </option>  
				</select>
				...
				<img name="img6" src=""  alt=""  width=650 height=500 ></a>
