...
<title>STAR - MIRS Project - Comparison to CloudSat</title>
<?php
...
<script language="javascript" type="text/javascript" src="validationcloudsat.js"></script>
...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_validationcloudsatv.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="validationcloudsat.php" method="post">

				<table border="0" cellpadding="0" cellspacing="0" class="tableGrid" bgcolor="#eeeeee">

				<TR><TD align=center bgcolor="#eeeeee" height=18>
				<input  type=submit  value="2 X 2 Panel" style="background-color: lightblue" > &nbsp;&nbsp;
				<B><font size=4>MIRS Comparison to CloudSat</font></B> (<em>Click image for large view</em>)
				</TD></TR>
