...
?>
  <tr>
    <td id="navCell">
			...
			require('includes/Sample_NavDiv_simulate2v.inc');
			?>
		</td>
		...
		If you need static access to these images, please contact MIRS webmaster.</h3>
			...
			<div class="padding" id="monitor">
				...
				<FORM NAME=form action="simulate2.php" method="post">
				...
				<input  type=submit  value="3 X 2 Panels" style="background-color: lightblue"> &nbsp;&nbsp;
				...
				<td class="imageContainer" id="panel1">
						<fieldset title="this fieldset groups form controls for the first row image">
				...
				<select class="productSelect" id="cond1" name="cond1" 
					title="choose a atmospheric condition" onChange="loadImage1();">
				...
				<select class="productSelect" id="yr1" name="yr1" 
					title="select year" onChange="loadImage1();">
<?php
// year options
...
?>
				...
				<img name="img1" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				</td>
				</tr>
				...
				<td class="imageContainer" id="panel2">
						<fieldset title="this fieldset groups form controls for the second right image">
				...
				<select class="productSelect" id="prod2" name="prod2" title="choose a product"
...
?>
				...
				<img name="img2" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				</td>
				</tr>
				...
				<td class="imageContainer" id="panel3">
						<fieldset title="this fieldset groups form controls for the 3rd image">
...
?>
				...
				<img name="img3" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				</td>
				</tr>
				...
				<td class="imageContainer" id="panel4">
						<fieldset title="this fieldset groups form controls for the 4th image">
...
?>
				...
				<img name="img4" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				</td>
				</tr>
				...
				<td class="imageContainer" id="panel5">
						<fieldset title="this fieldset groups form controls for the 5th image">
...
?>
				...
				<img name="img5" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				...
				<td class="imageContainer" id="panel6">
						<fieldset title="this fieldset groups form controls for the 6th image">
				...
				<select class="productSelect" id="prod6" name="prod6" title="choose a product"
...
?>
				...
				<img name="img6" src="" alt="" width="650" height="500" style="display:block; clear:both; position:relative; left:40px;" /></a>
				</td>
				</tr>
