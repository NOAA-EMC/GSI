...
var satellite_gcomw1 = new satellite_object("gcomw1", "chisq clw em(6v:6h:10v:10h:18v:18h:23v:23h:36v:36h:89v:89h) iwp lwp nattempt niter psfc qc rr rwp sfc(cyl:pn) tbc(6v:6h:10v:10h:18v:18h:23v:23h:36v:36h:89v:89h) tbu(6v:6h:10v:10h:18v:18h:23v:23h:36v:36h:89v:89h) temp(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb) tpw tskin wv(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb)");
var satellite_trmm   = new satellite_object("trmm",   "chisq clw em(11v:11h:19v:19h:21v:37v:37h:85v:85h) hour iwp lwp nattempt niter psfc qc rr rwp sfc(cyl:pn) tbc(11v:11h:19v:19h:21v:37v:37h:85v:85h) tbu(11v:11h:19v:19h:21v:37v:37h:85v:85h) temp(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb) tpw tskin wspd wv(100mb:200mb:300mb:400mb:500mb:600mb:700mb:800mb:850mb:900mb:950mb)");
...
SENSORTAG["aqua"]   = "/mirs_adv_eos_gcomw1_amsr2_";
...
IMGDIRS["metopB"] = "img_hr/";
IMGDIRS["f16"]    = "img_hr/";
IMGDIRS["f18"]    = "img_hr/";
IMGDIRS["aqua"]   = "img_hr/";
IMGDIRS["gcomw1"] = "img_hr/";
IMGDIRS["trmm"]   = "img_hr/";
IMGDIRS["gpm"]    = "img_hr/";
IMGDIRS["npp"]    = "images/";
IMGDIRS["n16"]    = "img_hr/";
...
function populateRegions( satval, obj_region ) {
	...
	obj_region.options.length = 0; 
	
	if( satval == 'n18' || satval == 'npp' || satval == 'metopB' ) {
	    for( i = 0; i < 5 ; i++ ) {
	        obj_region.options[i] = new Option();
	        obj_region.options[i].value = REGIONVALS[i];
	        obj_region.options[i].text  = REGIONTXTS[i];
	    } 		
	}
	else if( satval == 'metopA' ) {
	    for( i = 0; i < 1 ; i++ ) {
	        obj_region.options[i] = new Option();
	        obj_region.options[i].value = REGIONVALS[i+5];
	        obj_region.options[i].text  = REGIONTXTS[i+5];
	    } 		
	}
	    ...
	    for( i = 0; i < 1 ; i++ ) {
	        obj_region.options[i] = new Option();
	        obj_region.options[i].value = REGIONVALS[i+4];
	        obj_region.options[i].text  = REGIONTXTS[i+4];
	    } 		
	}
	    ...
	    for( i = 0; i < 1 ; i++ ) {
	        obj_region.options[i] = new Option();
	        obj_region.options[i].value = REGIONVALS[i+6];
	        obj_region.options[i].text  = REGIONTXTS[i+6];
	    } 		
	}
	    ...
	    for( i = 0; i < 1 ; i++ ) {
	        obj_region.options[i] = new Option();
	        obj_region.options[i].value = REGIONVALS[i+7];
	        obj_region.options[i].text  = REGIONTXTS[i+7];
	    } 		
	}
...
function loadInit( sat1,region1,cend1,sfc1,prod1,layer1,yr1,mo1,dy1,
