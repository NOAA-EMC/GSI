...
if [[ "${step_fwd}" -eq 1 ]] ; then
  ...
  ${monitorFwd} ${logFile} ${fwdControlFile} ${binPath} ${satId} ${gdasData} ${fwdCloudOffOrOn}\
  "${rdirExt}"
fi
...
find ${figs4BiasDir} -name "*_gdas_*.png" -exec cp -f {} /net/www/www/corp/scsb/mirs/images/${satId}/${rdirAnalysExt} \;
find ${figs4BiasDir} -name "*_mspps_*.png" -exec cp -f {} /net/www/www/corp/scsb/mirs/images/${satId}/${rdirAnalysExt} \;
...
#checkBias ${satId} ${biasPath} ${nedtBefFMFile} ${tune1File} ${rdirAnalysExt} \
#	  ${determineBiasSrc} ${IDL} ${controlDataPath} ${gfsData} "Kevin.Garrett@noaa.gov"

#---remove gridded data to free up space
cd ${grid4BiasDir}
#mkdir -p /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
#cp GRID*gdas* /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
#cp P2P*gdas* /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
#chmod 775 -R /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}

mkdir -p /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirAnalysExt}
cp GRID*gdas* /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirAnalysExt}
chmod 775 -R /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirAnalysExt}

rm *gdas*.dat

cp ${perfsMonitorPath}/*gdas*.png /net/www/www/corp/scsb/mirs/images/${satId}/bias

find /net/www/www/corp/scsb/mirs/images/${satId}/${rdirAnalysExt} -name "*.png" -exec chmod -f 664 {} \; 
echo "OK: ${rootPath}/scripts${0/./} ${rdirAnalysExt}"
