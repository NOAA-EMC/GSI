...
if [[ "${step_fwd}" -eq 1 ]] ; then
  ...
  ${monitorFwd} ${logFile} ${fwdControlFile} ${binPath} ${satId} ${ecmwfData} ${fwdCloudOffOrOn}\
  "${rdirExt}"
fi
...
checkBias ${satId} ${biasPath} ${nedtBefFMFile} ${tune1File} ${rdirAnalysExt} \
	  ${determineBiasSrc} ${IDL} ${controlDataPath} ${ecmwfData} "Wanchun.Chen@noaa.gov, Kevin.Garrett@noaa.gov"

#---remove gridded data to free up space
cd ${grid4BiasDir}
#mkdir -p /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
#cp GRID*ecmw* /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
...
cp GRID*ecmw* /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirAnalysExt}
