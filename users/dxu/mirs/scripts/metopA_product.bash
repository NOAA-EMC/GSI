...
. /home/pub/mirs_operational/setup/metopA_pcf_daily.bash
...
chmod 775 -R ${archivePath}/edr/${satId}_amsua_mhs/${rdirExt}
chmod 775 -R ${archivePath}/dep/${satId}_amsua_mhs/${rdirExt}
...
checkQC ${perfsMonitorPath} ${satId} "Sid.Boukabara@noaa.gov, Kevin.Garrett@noaa.gov"
