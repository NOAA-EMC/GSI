...
find ${figs4BiasDir} -name "*gdas*.png" -exec cp -f {} /net/www/www/smcd/mirs/images/${satId}/${rdirAnalysExt} \;


figs4BiasDir=`dirname ${figs4BiasDir}`
biasMonitor ${biasPath} ${figs4BiasDir} ${satId} ${determineBiasSrc} ${IDL} \
  ${biasVerifControlFile} ${controlDataPath} ${gdasData} ${version} ${fmType}
