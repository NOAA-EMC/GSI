...
. /home/pub/mirs_operational/setup/n18_pcf_daily.bash
...
if [[ ${satId} == "f16" || ${satId} == "aqua" || ${satId} == "f18" || ${satId} == "npp" || ${satId} == "fy3ri" || ${satId} == "trmm" || ${satId} == "gpm" ]] ; then
...
qcRetrieval ${depDir} ${depList} ${orbitMonPath} ${IDL} ${gridSrc} \
  ...
  "http://www.orbit2.nesdis.noaa.gov/corp/scsb/mirs/dataquality.php" ${controlDataPath}
...
find ${qcCheckDir} -name "*.png" -exec cp -f {} /net/www/www/corp/scsb/mirs/images/${satId}/${rdirExt} \;
cp ${figsDir}/*nedt*png      /net/www/www/corp/scsb/mirs/images/${satId}/nedt
...
#find ${qcCheckDir} -name "*.png" -exec cp -f {} /net/www-dev/www/mirs/images/${satId}/${rdirExt} \;
#cp ${figsDir}/*nedt*png      /net/www-dev/www/mirs/images/${satId}/nedt
...
mkdir -p /net/www/aftp/pub/corp/scsb/mirs/rain/${rdirExt}
cd /net/www/aftp/pub/corp/scsb/mirs/rain/${rdirExt}
mv /net/www/www/corp/scsb/mirs/data/${satId}/${satId}_mirs_dep_${yyyymmdd}.tar.gz ./
chmod -fR 775 /net/www/aftp/pub/corp/scsb/mirs/rain/${rdirExt}

#copy edr and dep to archive
archivePath=/net/orbit272l/disk1/pub/archive
mkdir -p ${archivePath}/edr/${satId}_amsua_mhs/${rdirExt}
mkdir -p ${archivePath}/dep/${satId}_amsua_mhs/${rdirExt}
cp ${edrDir}/* ${archivePath}/edr/${satId}_amsua_mhs/${rdirExt}
cp ${depDir}/* ${archivePath}/dep/${satId}_amsua_mhs/${rdirExt}
chmod -fR 775 ${archivePath}/edr/${satId}_amsua_mhs/${rdirExt}
chmod -fR 775 ${archivePath}/dep/${satId}_amsua_mhs/${rdirExt}

#copy gridded data to orbit082l/disk3
#mkdir -p /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirExt}
#cp ${gridDir}/GRID* /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirExt}
#chmod 775 -R /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirExt}

mkdir -p /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirExt}
cp ${gridDir}/GRID* /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirExt}
chmod 775 -R /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirExt}

checkNEDT ${satId} ${nedtSensor1Sensor2Path} ${fileExt} ${tune1File} \
       ${nedtMonitorSrc} ${IDL} ${controlDataPath} \
       "Wanchun.Chen@noaa.gov, Kevin.Garrett@noaa.gov, Limin.Zhao@noaa.gov, Jiang.Zhao@noaa.gov"

checkQC ${perfsMonitorPath} ${satId} "Kevin.Garrett@noaa.gov, Sid.Boukabara@noaa.gov"


cd /net/orbit267l/disk1/pub/mirs_operational/data/TestbedData/Outputs/dep/${satId}_amsua_mhs
chmod -f 775 ${rdirExt}
