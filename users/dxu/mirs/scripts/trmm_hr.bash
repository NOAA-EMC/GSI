...
mkdir -p /net/www/www/smcd/mirs/img_hr/${satId}/${identifier}
find ${figsDir} -name "*.png"  -exec chmod 664 {} \;
find ${figsDir} -name "*.png"  -exec cp {} /net/www/www/smcd/mirs/img_hr/${satId}/${identifier} \;
