...
cd ${grid4BiasDir}
#mkdir -p /net/orbit082l/disk3/pub/mirs/grid/f18_ssmis/${rdirAnalysExt}
#cp GRID*ecmw* /net/orbit082l/disk3/pub/mirs/grid/f18_ssmis/${rdirAnalysExt}
#chmod 775 -R /net/orbit082l/disk3/pub/mirs/grid/f18_ssmis/${rdirAnalysExt}

mkdir -p /net/orbit272l/disk1/pub/archive/grid/f18_ssmis/${rdirAnalysExt}
cp GRID*ecmw* /net/orbit272l/disk1/pub/archive/grid/f18_ssmis/${rdirAnalysExt}
chmod 775 -R /net/orbit272l/disk1/pub/archive/grid/f18_ssmis/${rdirAnalysExt}
