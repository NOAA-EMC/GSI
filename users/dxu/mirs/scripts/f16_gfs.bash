...
find ${figs4BiasDir} -name "*_gfs_*.png" -exec cp -f {} /net/www/www/corp/scsb/mirs/images/${satId}/${rdirAnalysExt} \;
#find ${figs4BiasDir} -name "*.png" -exec cp -f {} /net/www-dev/www/mirs/images/${satId}/${rdirAnalysExt} \;
...
#cp GRID*gfs* /net/orbit082l/disk3/pub/mirs/grid/f16_ssmis/${rdirAnalysExt}
...
cp GRID*gfs* /net/orbit272l/disk1/pub/archive/grid/f16_ssmis/${rdirAnalysExt}
chmod 775 -R /net/orbit272l/disk1/pub/archive/grid/f16_ssmis/${rdirAnalysExt}

rm *gfs*.dat

#cp ${perfsMonitorPath}/*gfs*.png /net/www/www/corp/scsb/mirs/images/${satId}/bias
