...
if [[ "${step_fwd}" -eq 1 ]] ; then
  ...
  ${monitorFwd} ${logFile} ${fwdControlFile} ${binPath} ${satId} ${gfsData} ${fwdCloudOffOrOn}\
  "${rdirExt}"
fi
...
#mkdir -p /net/www-dev/www/mirs/images/${satId}/${rdirAnalysExt}
...
#	    ${IDL} ${biasVerifControlFile} ${controlDataPath} ${gfsData}\
#           ${version} ${fmType}
...
#cp GRID*gfs* /net/orbit082l/disk3/pub/mirs/grid/${satId}_amsua_mhs/${rdirAnalysExt}
...
cp GRID*gfs* /net/orbit272l/disk1/pub/archive/grid/${satId}_amsua_mhs/${rdirAnalysExt}
