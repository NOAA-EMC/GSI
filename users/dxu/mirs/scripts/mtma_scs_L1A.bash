...
#modelErrFile1ToUse=${biasPath}/ModelErrFile_${satId}_2011_12_09.dat_ecmw
#modelErrFile2ToUse=${biasPath}/ModelErrFile_${satId}_2011_12_09.dat_ecmw
...
if [[ "${step_nwp}" -eq 1 ]] ; then
    echo "calling prepNWP"
    prepNWP ${fmsdrPath} ${rdirAnalysExt} "${extResol}" ${satId} ${ecmwfData}\
