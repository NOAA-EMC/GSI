...
mkdir -p /net/www/www/smcd/mirs/images/${satId}/${rdirExt}
find ${figsDir} -name "*.png" -exec cp -f {} /net/www/www/smcd/mirs/images/${satId}/${rdirExt} \;

mkdir -p /net/www/www/smcd/mirs/images/${satId}/${rdirAnalysExt}
find ${figs4BiasDir} -name "*.png" -exec cp -f {} /net/www/www/smcd/mirs/images/${satId}/${rdirAnalysExt} \;

mkdir -p /disk1/pub/archive/edr/trmm_tmi/${rdirExt}/
mkdir -p /disk1/pub/archive/dep/trmm_tmi/${rdirExt}/
mkdir -p /disk1/pub/archive/grid/trmm_tmi/${rdirExt}/

cp ${edrDir}/EDR*   /disk1/pub/archive/edr/trmm_tmi/${rdirExt}/
cp ${depDir}/DEP*   /disk1/pub/archive/dep/trmm_tmi/${rdirExt}/
cp ${gridDir}/GRID* /disk1/pub/archive/grid/trmm_tmi/${rdirExt}/
#cp ${gridDir}/P2P*  /disk1/pub/archive/grid/trmm_tmi/${rdirExt}/
