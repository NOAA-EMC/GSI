...
!--------------------------------------------------------------------------------
  ...
  RESULT( Error_Status )
    ...
    ! KJG MOD TO GET LAMBERTIAN FOR NON OCEAN
    RTV%Diffuse_Surface = .FALSE.
    IF (Surface%Ice_Coverage .gt. 0)  RTV%Diffuse_Surface = .TRUE.
    IF (Surface%Land_Coverage .gt. 0) RTV%Diffuse_Surface = .TRUE.
    IF (Surface%Snow_Coverage .gt. 0) RTV%Diffuse_Surface = .TRUE.
