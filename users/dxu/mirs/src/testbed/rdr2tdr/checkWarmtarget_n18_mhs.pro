...
;----Set input filename
;file_in   = 'fort.56'
file_in   = '/net/orbit006l/home/sidb/mirs_working/data/TestbedData/nedt/n18_mhs/n18_mhs_wt_2007_11_28.dat'
...
imp:
        ...
        FOR ichan=0,nch_m-1 DO BEGIN
            FOR k=0L,nEffFiles-1 DO BEGIN
                ...
                plot,y,xtitle='Index',ytitle='Warm Target Equivalent TB [K]',$
                  title='NOAA18/MHS Channel#'+string(ichan+1,'(i2)')+' Stdev:'+string(stdev(y),'(f7.2)'),$
    ...
    IF (plot_NEDT eq 1) THEN BEGIN
        ...
        !p.multi=1
        x=findgen(nch_m)+1
        plot,x,stdevVec(*,0),xtitle='Channel Index',ytitle='NEDT [K]',charsize=1.5,title='NOAA-18 MHS',$
          psym=-8,symsize=1.5
