!$Id: rdr2tdr_f17_ssmis.f90 1043 2008-05-01 21:05:18Z sidb $
!===============================================================
! Name:       rdr2tdr_f17_ssmis
!
!
! Type:         Main Program
!
...
!
! History:
!       05-01-2008      Wanchun Chen     Original Coder
!
!===============================================================
Program rdr2tdr_f17_ssmis
  ...
  INTEGER, PARAMETER ::  pol_ch01 = 5
  INTEGER, PARAMETER ::  pol_ch02 = 5
  INTEGER, PARAMETER ::  pol_ch03 = 5
  INTEGER, PARAMETER ::  pol_ch04 = 5
  INTEGER, PARAMETER ::  pol_ch05 = 5
  ...
  FILE_LOOPS: DO IFILE=1,nFiles
    ...
    !ssmisTdrFile='NPR.TDRN.SB.D08075.S0403.E0541.B2273637.NS'
