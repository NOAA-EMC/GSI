	SUBROUTINE ST_REAL  ( string, rval, iret )
C************************************************************************
C* ST_REAL                                       			*
C*									*
C* This subroutine converts a string into a real.			* 
C*									*
C* ST_REAL  ( STRING, RVAL, IRET )					*
C*									*
C* Input parameters:							*
C*	STRING		CHAR*		String				*
C*									*
C* Output parameters:							*
C*	RVAL		REAL   		Real  value      		*
...
C* M. Tsidulko/NCEP      12/04  Modified to convert to real instead of  *
C*                              integer                                 *
C************************************************************************
C* GEMPRM.PRM
C*
