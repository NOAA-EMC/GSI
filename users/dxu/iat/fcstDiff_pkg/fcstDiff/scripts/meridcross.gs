...
'set black -.1 .1'
'd cnv'
'draw title \\\F24 T126 Meridional cross-section deep convective heating [K/day] at 'clat%'N'
'printim meridcnv_crossf24.png x1000 y800'
...
'set gxout contour'
'd lw'
'draw title \\\F24 T126 Meridional cross-section longwave radiative heating [K/day] at 'clat%'N'
'printim meridlwave_crossf24.png x1000 y800'
...
'set gxout contour'
'd sw'
'draw title \\\F24 T126 Meridional cross-section shortwave radiative heating [K/day] at 'clat%'N'
'printim meridswave_crossf24.png x1000 y800'
...
'set gxout contour'
'd sha'
'draw title \\\F24 T126 Meridional cross-section shallow convective heating [K/day] at 'clat%'N'
'printim meridshall_crossf24.png x1000 y800'
...
'set gxout contour'
'd vdf'
'draw title \\\F24 T126 Meridional cross-section vertical diffusion heating [K/day] at 'clat%'N'
'printim meridvdiff_crossf24.png x1000 y800'
...
'set gxout contour'
'd lrg'
'draw title \\\F24 T126 Meridional cross-section large scale condensation heating [K/day] at 'clat%'N'
'printim meridlrg_crossf24.png x1000 y800'
'quit'
