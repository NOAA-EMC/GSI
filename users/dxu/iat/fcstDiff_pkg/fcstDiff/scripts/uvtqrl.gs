...
'set lon 0 360'
'set lat -90 90'
*'define fld=(ugrd(t=1)+ugrd(t=2)+ugrd(t=12))/3'
'define fld=(ugrd(t=6)+ugrd(t=7)+ugrd(t=8))/3'
'define um=ave(fld,lon=0,lon=360,-b)'
*
*'define fld=(vgrd(t=1)+vgrd(t=2)+vgrd(t=12))/3'
'define fld=(vgrd(t=6)+vgrd(t=7)+vgrd(t=8))/3'
'define vm=ave(fld,lon=0,lon=360,-b)'
*
*'define fld=(tmp(t=1)+tmp(t=2)+tmp(t=12))/3'
'define fld=(tmp(t=6)+tmp(t=7)+tmp(t=8))/3'
'define tm=ave(fld,lon=0,lon=360,-b)'
*
'set lev 1000 300'
*'define fld=(spfh(t=1)+spfh(t=2)+spfh(t=12))/3'
'define fld=(spfh(t=6)+spfh(t=7)+spfh(t=8))/3'
...
'set strsiz 0.2'
'set string 1 tc 6 0'
'draw string 5.5 8.0 JJA Mean : NCEP Reanalysis'
