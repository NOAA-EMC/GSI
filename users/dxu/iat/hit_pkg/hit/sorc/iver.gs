...
_cbasin    = 'Hurricane Intensity Errors - '%basin ' '%year
_cmodtyp   = ' '%period
_reltitle  = '% Error Relative to SHIFOR'
_topylabel = 'Average Intensity Error (kts)'
...
*--------------------------------------------------*
* Now plot the skill levels on the lower plot....  *
*--------------------------------------------------*

'set vpage 0 8.5 0 5.5'
'set grads on'
'set xaxis 0 120 12'
'set vrange 'skvrlo' 'skvrhi
'set yaxis 'skvrlo' 'skvrhi' 'botyincr
'set missconn on'
'set grads off'
...
while (mtime <= maxplot)
  ...
  'set t 'mtime
  modstring = modparms(_modname.mtime)
* modcol   = subwrd(modstring,1)
* linetype = subwrd(modstring,2)
* marktype = subwrd(modstring,3)
  modcol   = mtime-nmodels+1
  linetype = solid
  marktype = mtime-nmodels+1

  if (_modname.mtime = 'CLIP' | _modname.mtime = 'CLP5')
    marktype = 0
    modcol   = 1                  
  endif
  if (_modname.mtime = 'clip' | _modname.mtime = 'clp5')
  ...
  if (_modname.mtime = 'SHFR' | _modname.mtime = 'shfr')
    marktype = 0
  endif
  if (_modname.mtime = 'SHF5' | _modname.mtime = 'shf5')
    marktype = 0
  endif
  ...
  pstring = _modname.mtime
  rc = plotleg(xleg,ypstart,relct,modcol,linetype,pstring,marktype)
  ...
  if (relct = 1)
    ...
    'set string 1 bc 6 90'
    'set strsiz 0.14 0.14'
    'draw string 'xylabst' 'ymid' '_reltitle
    ...
    'set string 1 bc 6'
    'set strsiz 0.135 0.135'
    'draw string 1.30 4.9 'ctitle

    ctitle = 'SKILL'
    'set string 1 bc 6'
    'set strsiz 0.135 0.135'
    'draw string 1.30 4.70 'ctitle

    ctitle = 'MOST'
    'set string 1 bc 6'
    'set strsiz 0.135 0.135'
    'draw string 1.30 0.8 'ctitle

    ctitle = 'SKILL'
    'set string 1 bc 6'
    'set strsiz 0.135 0.135'
    'draw string 1.30 0.60 'ctitle
...
*if (cmodel = 'UKM' | cmodel = 'ukm' | cmodel = 'GHYB' | cmodel = 'ukmi')
*  return '26 solid 1'
*endif
...
*if (cmodel = 'VBAR' | cmodel = 'vbar' | cmodel = '206C' | cmodel = '206c')
*  return '21 solid 6'
*endif
...
if (cmodel = 'ETA' | cmodel = 'eta' | cmodel = 'HCBS' | cmodel = 'etai')
  return '20 solid 6'
endif
...
if (cmodel = 'HWRI' | cmodel = 'a98e' | cmodel = 'H007' | cmodel = 'p91e')
  return '25 dash 6'
endif
if (cmodel = 'AEMN' | cmodel = 'aemn' | cmodel = 'AEMI' | cmodel = 'aemi')
  return '25 dash 11'
endif
