...
export DATEST=20130501                              ;#forecast starting date
export DATEND=20131130                              ;#forecast ending date
...
export ftpdir=/home/people/emc/www/htdocs/gmb/STATS_vsdb/allmodel/track/2013 
...
if [ $BASIN = "WP" ]; then
newlisti=${newlist}"AVNO HWRF JTWC"
newlistt=${newlist}"AVNO HWRF JTWC"
else
...
newlisti=${newlist}"AVNO HWRF OFCL"
newlistt=${newlist}"AVNO HWRF OFCL"
fi
