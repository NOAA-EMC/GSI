'reinit'
'open /ptmp2/wd23sm/pgb/pgb.ctl1s'
'open /ptmp2/wd23sm/pgb/pgb.ctl2s'
'open /ptmp2/wd23sm/pgb/pgb.ctl3s'
'open /emcsrc3/wd23sm/scripts/climrl.ctl'
'enable print outt2s.gr'
*
...
'set lon 0 360'
'set lat -90 90'
'define um=ave(tmp,t=1,t=3)'
'define vm=ave(tmp.2,t=1,t=3)'
'define tm=ave(tmp.3,t=1,t=3)'
*'define qm=(tmp.4(t=1)+tmp.4(t=2)+tmp.4(t=12))/3'
'define qm=(tmp.4(t=6)+tmp.4(t=7)+tmp.4(t=8))/3'
*
*
*  Plotting Zonal Wind
*
...
'set strsiz 0.2'
'set string 1 tc 6 0'
'draw string 5.5 8.0 JJA Mean 850 hPa T'
