...
5002                continue  
     ...
     +                  fcstdata(ifh,ivr,ilv,i).lt.0.0) ) goto 5003  !for aerosol/smoke
                    ...
                    if(continue_mrk(ivr).eq.9 .and.(
     +                 obsvdata(ifh,ivr,ilv,i).eq.0.0 .or.
     +                  fcstdata(ifh,ivr,ilv,i).eq.0.0) ) goto 5003  !for soil temperature and soil moisture
...
5003                continue  
     ...
     +                  fcstdata(ifh,ivr,ilv,i).lt.0.0) ) goto 5004  !for aerosol/smoke
                    ...
                    if(continue_mrk(ivr).eq.9 .and.(
     +                 obsvdata(ifh,ivr,ilv,i).eq.0.0 .or.
     +                  fcstdata(ifh,ivr,ilv,i).eq.0.0) ) goto 5004  !for soil temperature and soil moisture
...
5004                continue  
     ...
     +                  fcstdata(ifh,ivr,ilv,i).lt.0.0) ) goto 5005      !  |
                    ...
                    if(continue_mrk(ivr).eq.9 .and.(
     +                 obsvdata(ifh,ivr,ilv,i).eq.0.0 .or.
     +                  fcstdata(ifh,ivr,ilv,i).eq.0.0) ) goto 5005  !for soil temperature and soil moisture
