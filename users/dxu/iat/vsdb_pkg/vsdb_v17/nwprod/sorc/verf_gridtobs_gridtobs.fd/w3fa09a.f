...
C
      ...
      REAL*8   ARG,H0,H1,H2
      real*8 tk
      real*8 D9264,D223,D323,D0,D05,D2
      data d9264 /-1.09264E1/
      data d2 /4.0E-2/
      data d223 /223.16/
      data d323 /323.16/
      data d0 /0.0/
...
C
c     ARG = -1.09264E1+4.0E-2*DMAX1(223.16,DMIN1(323.16,TK))
      arg = d9264 + d2 * dmax1(d223,dmin1(d323,tk))
c     print*,'arg=',arg
c     H0  = 0.0
c     H1  = 0.0
      h0 = d0
...
C
      DO 10 I=1,9
        ...
        H0 = ARG * H1 - H2 + C(10-I)
 10   CONTINUE
c     W3FA09A = 0.5 * (C(1) - H2 + H0)
      w3fa09a = d05 * (C(1) - H2 + H0)
      RETURN
      END
