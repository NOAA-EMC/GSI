...
C--fyang, add definiton for global coverage
        if(namarea.eq.'GGLB') then
!!      if(namarea.eq.'G3') then
        ...
        if(namarea.eq.'GEUR') then
          if(xob.le.-10.0.or.xob.ge.45.0.or.yob.le.30.0.or.yob.ge.
     *        70.0) then
          inarea=-1
          RETURN
          else
        ...
        if(namarea.eq.'GASI') then
          if(xob.le.60.0.or.xob.ge.145.0.or.yob.le.5.0.or.yob.ge.
     *        65.0) then
          inarea=-1
          RETURN
          else
     ...
     *        30.0) then
        ...
        if(namarea.eq.'GSA') then
          if(xob.le.-90.0.or.xob.ge.-35.0.or.yob.le.-50.0.or.yob.ge.
     *        15.0) then
          inarea=-1
          RETURN
          else
     ...
     *        60.0) then
        ...
        if(namarea.eq.'GAUS') then
          if(xob.le.105.0.or.xob.ge.165.0.or.yob.le.-45.0.or.yob.ge.
     *        0.0) then
          inarea=-1
          RETURN
          else
