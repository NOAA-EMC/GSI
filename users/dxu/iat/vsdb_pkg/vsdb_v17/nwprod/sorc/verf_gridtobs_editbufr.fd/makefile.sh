...
if [ $FCMP = xlf_r ] ; then
 ...
 export W3LIB="w3_4"
 export LIBS="-L$LIBDIR -lbufr_4_64 -lbacio_4 -l$W3LIB "
 export FFLAGS="-qcheck -qextchk -qfixed -bnoquiet "
else
 export LIBS="-L$LIBDIR  -lbufr_4_64 -lbacio_4 -l$W3LIB "
 #export LIBS="-L$LIBDIR  -lbufr_v10.2.3_4_64 -lbacio_4 -l$W3LIB "
 export FFLAGS=" -convert big_endian  -heap-arrays -O0"
