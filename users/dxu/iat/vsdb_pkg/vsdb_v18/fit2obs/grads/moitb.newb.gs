...
* cycle moisture rms and bias

qsub=adp; tsub=ADPUPA; count=qcnt; rmsd='qos+qfs-2*qfo'; bias='qf-qo'

varn=1; while (varn<=2)
if(varn=1);var=q ;endif
if(varn=2);var=qb;endif
...
* cycle levels 1-low clouds 2-middle clouds 3-high clouds

levs=1; leve=15; levx=levs; while (levx<=leve); level=getlev(levx); titlev=getlevt(levx)

if(varn=1); titvar='Moisture'; titlab='RMS fits to 'tsub
if(level>=300); ymin=0; ymax=0.5; endif
if(level>=500); ymin=0; ymax=2.0; endif
if(level>=850); ymin=0; ymax=4.0; endif
if(level>=925); ymin=0; ymax=4.0; endif
endif  

if(varn=2); titvar='Moisture'; titlab='BIAS f-o to 'tsub       
if(level>=300); ymin=-1; ymax=1; endif
if(level>=500); ymin=-1; ymax=1; endif
if(level>=850); ymin=-2; ymax=2; endif
if(level>=925); ymin=-2; ymax=2; endif
endif  
...
if(levx=1);titlev='925 mb';endif;
if(levx=2);titlev='850 mb';endif;
if(levx=3);titlev='500 mb';endif;
if(levx=4);titlev='300 mb';endif;
return titlev
