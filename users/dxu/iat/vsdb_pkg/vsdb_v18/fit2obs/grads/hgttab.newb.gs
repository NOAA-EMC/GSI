...
sub=1; qsub=adp; tsub=ADPUPA; count=zcnt; rmsd='zos+zfs-2*zfo'; bias='zf-zo'

varn=1; while (varn<=2)
if(varn=1);var=z ;endif
if(varn=2);var=zb;endif

* cycle levels 

levs=1; leve=15; levx=levs; while (levx<=leve); level=getlev(levx); titlev=level'mb'

if(varn=1); titvar='Height'; titlab='RMS Fits to 'tsub
if(level>=10  ); ymin=0; ymax=200; endif
if(level>=200 ); ymin=0; ymax=100; endif
if(level>=500 ); ymin=0; ymax=50 ; endif
if(level>=1000); ymin=0; ymax=50 ; endif
endif

if(varn=2); titvar='Height'; titlab='BIAS f-o to 'tsub
if(level>=10  ); ymin=-200; ymax=200; endif
if(level>=200 ); ymin=-100; ymax=100; endif
if(level>=500 ); ymin=-50 ; ymax=50 ; endif
if(level>=1000); ymin=-50 ; ymax=50 ; endif
endif
...
'set strsiz 0.13'
'set string 1 tl 6'
'draw string 0.1 10.9 'exp' 'titvar' 'level' mb 'titlab' 'ts00' - 'te00
*
