...
regx=1; rege=7; while (regx<=rege); titreg=getregt(regx); greg=getgreg(regx)   

* cycle levels 

levx=1; leve=3; while (levx<=leve); level=getlev(levx); titlev=getlevt(levx)

if(varn=1); titvar='Temperature'; titlab='RMS Fits to 'tsub
if(level=1000); ymin=0; ymax=5; endif
if(level=700 ); ymin=0; ymax=5; endif
if(level=300 ); ymin=0; ymax=5; endif
endif
...
if(level=1000); ymin=0; ymax=20; endif
if(level=700 ); ymin=0; ymax=20; endif
if(level=300 ); ymin=0; ymax=20; endif
endif

if(varn=4); titvar='Wind Speed '; titlab='BIAS f-o to 'tsub
if(level=1000); ymin=-10; ymax=10; endif
if(level=700 ); ymin=-10; ymax=10; endif
if(level=300 ); ymin=-10; ymax=10; endif
endif
...
if(levx=1);titlev='(1000-700)mb';endif;
if(levx=2);titlev='(700-300)mb';endif;
if(levx=3);titlev='(300-150)mb';endif;
return titlev
