...
* cycle W rms and bias

sub=1; qsub=adp; tsub=ADPUPA; count=wcnt; rmsd='uvo+uvf-2*uv' ; bias='spd'   
...
if(varn=1); titvar='Vector Wind'; titlab='RMS Fits to 'tsub          
if(level>=10 ); ymin=0; ymax=12; endif
if(level>=200); ymin=0; ymax=15; endif
if(level>=500); ymin=0; ymax=12; endif
if(level>=700); ymin=0; ymax=10; endif
if(level>=850); ymin=0; ymax=10; endif
endif

if(varn=2); titvar='Wind Speed '; titlab='BIAS f-o to 'tsub
if(level>=10 ); ymin=-5; ymax=5; endif
if(level>=200); ymin=-5; ymax=5; endif
if(level>=500); ymin=-3; ymax=3; endif
if(level>=700); ymin=-3; ymax=3; endif
if(level>=850); ymin=-3; ymax=3; endif
endif
