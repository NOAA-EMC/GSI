...
level=getlev(levx)
*
if(level<=1000); ymin=0; ymax=3.0 ; endif
if(level<=850) ; ymin=0; ymax=3.0 ; endif
if(level<=500) ; ymin=0; ymax=2.0 ; endif
if(level<=200) ; ymin=0; ymax=0.5 ; endif
if(level<=70)  ; ymin=0; ymax=0.5 ; endif
*
