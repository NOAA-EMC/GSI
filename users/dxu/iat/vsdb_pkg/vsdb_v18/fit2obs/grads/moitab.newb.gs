...
sub=1; qsub=adp; tsub=ADPUPA; count=qcnt; rmsd='qos+qfs-2*qfo'; bias='qf-qo'
...
if(varn=1); titvar='Moisture'; titlab='RMS Fits to 'getsub(sub)
if(level>=300); ymin=0; ymax=0.5; endif
if(level>=500); ymin=0; ymax=2.0; endif
if(level>=850); ymin=0; ymax=4.0; endif
endif  

if(varn=2); titvar='Moisture'; titlab='BIAS f-o to 'getsub(sub)
