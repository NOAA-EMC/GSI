...
export expnlist=${expnlist:-"gfs prhw14"}             ;#experiments, up to 8; gfs will point to ops data
...
export cdate=${DATEST:-20140601}              ;#starting verifying date
export ndays=${ndays:-92}                      ;#number of days (cases)
...
export ptop=${ptop:-10}                       ;#top pressure for zonal mean maps
