;---------------------------------------------------------------------------------
; Name:  configParam_MetOp_B_AMSUA_MHS.pro
;
; Type:  IDL Program
;
; Description:
;   To config parameters for MetOp_B_AMSUA_MHS
...
;
;---------------------------------------------------------------------------------
PRO configParam_MetOp_B_AMSUA_MHS, paramStruct
   ...
   paramStruct.maxBT_Values =  $
       ...
       300, 280, 280, 280 ]
   paramStruct.sensorName = 'MetOp_B_AMSUA_MHS'
