...
if(fcs1=12);ts00=ts12;te00=te12;endif
...
if(level<=500) ; ymin=0; ymax=4  ; endif
if(level<=200) ; ymin=0; ymax=4  ; endif
if(level<=70)  ; ymin=0; ymax=4  ; endif
