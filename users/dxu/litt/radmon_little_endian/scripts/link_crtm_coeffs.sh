...
#
# $Id: link_crtm_coeffs.sh 38565 2014-03-28 19:43:54Z Michael.Lueken@noaa.gov $

script_id()
{
  REVISION='$Revision: 38565 $'
  LAST_CHANGED_DATE='$LastChangedDate: 2014-03-28 19:43:54 +0000 (Fri, 28 Mar 2014) $'
  echo
