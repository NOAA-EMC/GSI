...
export WEBDIR=/export/lnx42/wd20xs/gsiqcweb2/pryv
...
$SUB -a $ACOUNT -e $listvar -j time_vert_${SUFFIX} -q dev -g devonprod -t 0:30:00 -o $LOGDIR/time_vert.log $SCRIPTS/time_vert.sh_new
