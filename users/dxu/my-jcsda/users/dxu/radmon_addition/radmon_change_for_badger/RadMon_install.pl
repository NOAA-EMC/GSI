...
#-------------------------------------------------------------------
   ...
   if( $machine ne "ccs" && $machine ne "zeus" && $machine ne "wcoss"  && $machine ne "badger") {
   ...
   if( $machine eq "badger" ) {
      $my_ptmp="export PTMP=/data/dxu/log_tmp";
      $my_stmp="export STMP=/data/dxu/wk_tmp";
   } 
