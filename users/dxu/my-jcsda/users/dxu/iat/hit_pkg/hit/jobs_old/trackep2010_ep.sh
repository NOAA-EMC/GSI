...
#for storm in  Agatha Blas Celia Darby Estelle Frank Georgette Howard Isis Javier Kay Lester Madeline Newton Orlene Paine Roslyn Seymour Tina Virgil Winifred Xavier Yolanda Zeke; do
for storm in  Agatha Blas Celia Darby Estelle Frank Georgette ; do
 case $storm in
  Agatha)      code1=ep012010.dat; DATEST=20100529; DATEND=20100530;;
  Blas)        code1=ep032010.dat; DATEST=20100617; DATEND=20100621;;
  Celia)       code1=ep042010.dat; DATEST=20100619; DATEND=20100629;;
  Darby)       code1=ep052010.dat; DATEST=20100623; DATEND=20100629;;
  Estelle)     code1=ep072010.dat; DATEST=20100807; DATEND=20100810;;
  Frank)       code1=ep092010.dat; DATEST=20100822; DATEND=20100828;;
  Georgette)   code1=ep122010.dat; DATEST=20100921; DATEND=20100923;;
 esac
OCEAN=EP
#-----------------------
...
export DATEST=${DATEST:-20100529}                             ;#forecast starting date
