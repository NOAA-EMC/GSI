...
TMPGRADS=/ptmp/$LOGNAME/${case}anlgesdiffdrop
mkdir -p $TMPGRADS
cd ${TMPGRADS}
#
...
'set string 1 tc 7'
'set strsiz .15 .15'
'draw string 5.1 8.0 Case:${case} Composite ANL-GES DIFF ${lev}mb var=${var} rms='rms
'printim COMP_${lev}_${case}_${var}.gif gif x700 y700'
*
'quit'
* 
* 
