...
/nwprod/util/ush/hpsstar getnostage /NCEPDEV/hpssuser/g01/glopara/WCOSS/$expt/${YYYY}${MM}${DD}${CYC}gfs.tar  ${tag}f00.gfs.$adate ${tag}f06.gfs.$adate ${tag}f12.gfs.$adate ${tag}f18.gfs.$adate ${tag}f24.gfs.$adate ${tag}f30.gfs.$adate ${tag}f36.gfs.$adate ${tag}f42.gfs.$adate ${tag}f48.gfs.$adate ${tag}f54.gfs.$adate ${tag}f60.gfs.$adate ${tag}f66.gfs.$adate ${tag}f72.gfs.$adate ${tag}f78.gfs.$adate ${tag}f84.gfs.$adate 
...
exit
echo "Finished copying" | mail -s "Finished copying all $expt pgb files" dana.carlis@noaa.gov
