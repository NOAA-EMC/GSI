...
##    database computation. Jack Woolen and Suranjana Saha provided the script 
...
(6) transfer maps and web templates to web servers for display. Example:     
    http://www.emc.ncep.noaa.gov/gmb/wx24fy/vsdb/Q3FY10_2010JJA/
...
(3)For those who has access to NCEP/EMC SVN, find    
    https://svnemc.ncep.noaa.gov/projects/verif/global/tags/vsdb_v17/    

(5)For users who have no access to NCEP computers and wish to install the entire package, 
   please get the package vsdb_exp_v17.tar by ftp from  http://ftp.emc.ncep.noaa.gov/gc_wmb/wx24fy/VRFY/
...
(2)Users who plan to buid the package from scratch on different computer platforms needs to 
    get the tarball (vsdb_exp_v17.tar), unpack it, then check build.sh to see how to compile 
    libraries and program executables based platform options. Please also note that the climate 
...
8. Removed the old "fits" directory. It has been replaced by the more advanced 
   "fit2obs" verification tool developed by Jack Woolen and Suru Saha.
...
Dear All,
I'd like to inform you a recent update of the VSDB-based global  model (GFS) verification package , version 07.   
...
There are a few options to update and run the package for verifying your experiments.
1).  Only copy the master script  /climate/save/wx24fy/VRFY/vsdb_exp/vsdbjob_submit.sh,  and run all subscripts from my directory.
2). Copy the entire package /climate/save/wx24fy/VRFY/vsdb_exp/vsdb_exp_v07.tar,  and install it under your account.  Feel free to make any changes.
3). Since there are no changes to  other components of the VSDB package, you may choose to only copy the directory /global/save/wx23sm/para_scripts/cver_1.1/vsdb/precip .

Please visit http://www.emc.ncep.noaa.gov/gmb/wx24fy/vsdb_glopara/pre13_2008/ to see the functionality of this VSDB package.

Please let me know if you'd like to have your name removed from this mailing list.
...
>
> I'd like to inform you a recent update of the VSDB-based model verification package , version 06.  This update is for offline verification.  The package embedded in the GFS parallel script remains the same.
>
> 1.   Suru's fit-to-obs tool that compares forecasts with rawindsonde observations has been automated and added to the package.
> 2.   Thanks to Moorthi, the package itself is now able to handle forecasts that are executed on different machines. 
> 3.  The master script vsdbjob_submit.sh has been modified and now is more flexible for turning on and off different verification components.
>
> You have two options to run the package.
> 1).  Only copy the master script dew:/climate/save/wx24fy/VRFY/vsdb_exp/vsdbjob_submit.sh,  and run the subscripts from my directory.
> 2). Copy the entire package dew:/climate/save/wx24fy/VRFY/vsdb_exp/vsdb_exp_v06.tar,  and install it under your account.  Feel free to make changes.
>
>>> ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
>>> Version 04 information  10 July 2008
>> I'd like to notify you two recent  changes to the VSDB-based model verification package. 
>>
>> 1.  An option is added to allow the users to choose either the GFS analysis or GDAS analysis as the verification truth (observations).  The option is called "anl_type" in  vsdbjob_submit.sh.  The default (previous)  option is  GFS analysis.   My thank goes to Russ Treadon for his suggestion.
>> 2.  Confidence/uncertainty tests are added to the AC dieoff curves and RMSE error growth curves. For instance, in the bottom portions of the two  plots attached to this mail the hollow bars indicate the 95% significance level, that is,  those AC/RMSE differences falling outside of the bars are significantly different at the 95% significance level.  My thanks go to Glenn and Steve for their suggestions.
>>
>>
>> ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
301-7638000 x 7296; fanglin.yang@noaa.gov
