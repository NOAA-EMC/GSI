...
C
C SUBROUTINE: W3FT212   CONVERT (361,91) GRID TO (185,129) LAMBERT GRID
...
C
C USAGE:  CALL W3FT212(ALOLA,ALAMB,INTERP)
C
...
C   INPUT FILES:  NONE
C
C   OUTPUT ARGUMENTS: ALAMB  - 185*129 REGIONAL - CONUS
C                              DOUBLE RESOLUTION
C                              (LAMBERT CONFORMAL). 23865 POINT GRID 
C                              IS AWIPS GRID TYPE 212
C
