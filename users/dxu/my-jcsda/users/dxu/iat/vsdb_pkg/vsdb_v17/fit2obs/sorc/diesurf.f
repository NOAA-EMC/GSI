       parameter(nvar=5,nlev=1,nstcs=6,nstcw=9)
       parameter(nreg=7,nsub=2,ntx=1000)
...
c
       ...
       write(*,*) "incr= ",incr
c
       iname = trim(mdldir)//'/f'//trim(fcshr)//'.surf.' 
       write(*,*) "iname= ",iname
c
...
c
      ...
      print'(3i8,3f8.2)',ireg,ilev,ivar,cnt,rms,avg
