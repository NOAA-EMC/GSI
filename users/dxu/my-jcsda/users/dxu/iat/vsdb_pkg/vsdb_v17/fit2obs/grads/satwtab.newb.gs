...
* cycle satwnd rms and bias

sub=6; qsub=satwnd; tsub=SATWND; count=wcnt; rmsd='uvo+uvf-2*uv'; bias='spd'          
...
if(varn=1); titvar='Vector Wind'; titlab='RMS Fits to 'getsub(sub) 
if(level=low); ymin=0; ymax=10; endif
if(level=mid); ymin=0; ymax=12; endif
if(level=hih); ymin=0; ymax=15; endif
endif

if(varn=2); titvar='Wind Speed'; titlab='BIAS f-o to 'getsub(sub)
...
'set strsiz 0.13'
'set string 2 tl 6'
'draw string 0.1 10.8 'exp' 'titvar' 'titlev' 'titlab' 'ts00' - 'te00
*
