       ...
       do n=1,nlev
         if(nhead(n,i,j,m).eq.0) then
           ...
           if(points(n,i,j).eq.0) then
             ...
             var_f(n,i,j,m)=max(0.0d0,vsdb(6,n,i,j)-vsdb(1,n,i,j)**2-vsdb(2,n,i,j)**2)
             var_a(n,i,j,m)=max(0.0d0,vsdb(7,n,i,j)-vsdb(3,n,i,j)**2-vsdb(4,n,i,j)**2)
             cor(n,i,j,m)=(vsdb(5,n,i,j)-vsdb(1,n,i,j)*vsdb(3,n,i,j)-vsdb(2,n,i,j)*vsdb(4,n,i,j))/ &
                        sqrt(var_f(n,i,j,m)*var_a(n,i,j,m))
             mse(n,i,j,m)=(max(0.0d0,(vsdb(6,n,i,j)+vsdb(7,n,i,j)-2*vsdb(5,n,i,j))))
             rms(n,i,j,m)=sqrt(mse(n,i,j,m))
             bias(n,i,j,m)=sqrt(vsdb(6,n,i,j))-sqrt(vsdb(7,n,i,j))
             e_m(n,i,j,m)=((vsdb(1,n,i,j)-vsdb(3,n,i,j))**2+(vsdb(2,n,i,j)-vsdb(4,n,i,j))**2)
