/* $Id: ncfortran.h,v 1.15 2001/03/09 22:59:14 russ Exp $ */
...
#define DIMIDS_cfQ(B)			int B[MAX_NC_DIMS];
...
#define PDIMIDS_cfQ(B)			int B[MAX_NC_DIMS];
...
#define COORDS_cfQ(B)			size_t B[MAX_NC_DIMS];
...
#define COUNTS_cfQ(B)			size_t B[MAX_NC_DIMS];
...
#define STRIDES_cfQ(B)			ptrdiff_t B[MAX_NC_DIMS];
...
#define MAPS_cfQ(B)			ptrdiff_t B[MAX_NC_DIMS];
