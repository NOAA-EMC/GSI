...
/* $Id: fort-v2compat.c,v 1.21 1998/02/17 20:11:47 steve Exp $ */
...
static int
c_nccre(
    char *pathname,	/* file name of new netCDF file */
...
static int
c_ncopn(
    char *pathname,		/* file name for netCDF to be opened */
...
c_ncdren (
    int ncid,			/* netCDF ID */
    int dimid,			/* dimension ID */
    char* dimname,		/* new name of dimension */
    int* rcode			/* returned error code */
)
{
...
c_ncvren (
    int ncid,		/* netCDF ID */
    int varid,		/* variable ID */
    char* varname,	/* new name for variable */
    int* rcode		/* returned error code */
)
{
...
c_ncacpy (
    ...
    char* attname,	/* name of attribute in input netCDF to be copied */
