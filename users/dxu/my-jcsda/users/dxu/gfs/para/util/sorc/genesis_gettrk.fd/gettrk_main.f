...
c                       divide by zero.
c   06-08-01  Marchok   Increased number of allowable forecast hours.  
c                       Made changes to accomodate new global ensemble 
c                       configuration (May 2006 changes).  Made changes
c                       to allow for hi-res ECMWF.
c
c Input files:
...
c     the search.
      ...
      if (dell < 1.24) then      ! GFS, MRF, NAM, NGM, NOGAPS, GDAS,
                                 ...
                                 ! Relocation, SREF Ensemble, ECMWF
        ri     = ritrk_most
        if (cparm == 'slp') then
          radinf = 300.0
        else
      ...
      if (atcfname == 'GDAS' .or. atcfname(1:2) == 'YP' .or.
     &    atcfname(1:2) == 'YN' .or. atcfname(1:2) == 'ZP' .or.
     &    atcfname(1:2) == 'ZN' .or. atcfname == 'AEAR') then
                    ! Different for relocation in GDAS and GFS
...
c
      if (ifh == 1) then
        if (atcfname == 'GFSO' .or. atcfname == 'EMX ' .or. 
     &      atcfname == 'GDAS' .or. atcfname == 'GFDT' .or.
     &      atcfname == 'UKX ' .or. atcfname == 'NGX ' .or.
     &      atcfname(1:3) == 'AP0' .or. atcfname(1:3) == 'AP1' .or.
     &      atcfname(1:3) == 'CP0' .or. atcfname(1:3) == 'CP1' .or.
     &      atcfname(1:3) == 'EP0' .or. atcfname(1:3) == 'EP1' .or.
     &      atcfname(1:3) == 'EP2' .or. atcfname(1:3) == 'EN0' .or.
     &      atcfname(1:3) == 'EN1' .or. atcfname(1:3) == 'EN2' .or.
     &      atcfname(1:3) == 'CC0' .or. atcfname(1:3) == 'EC0' .or.
...
c
      parameter (jf=512*256,lugb=11,lugi=31) 
      real      f(jf)
...
c     search for and come up empty for.  For GFDL, we have 35m winds.
     ...
     &    inp%model == 10 .or. inp%model == 13) then
        iglevtyp(12) = 105
        iglevtyp(13) = 105
        iglev(12)    = 10
        iglev(13)    = 10
...
c
      ...
      parameter (lugb=11,lugi=31,jf=512*256)
