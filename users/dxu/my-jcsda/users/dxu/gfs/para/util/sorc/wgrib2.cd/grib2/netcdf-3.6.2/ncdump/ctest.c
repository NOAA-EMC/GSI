...
main() {			/* create ctest0.nc */
   ...
   int D2_dim;
   int D3_dim;
   int dim_dash_name_dash_dashes_dim;
   int dim_dot_name_dot_dots_dim;
   ...
   size_t D2_len = 2;
   size_t D3_len = 3;
   size_t dim_dash_name_dash_dashes_len = 4;
   size_t dim_dot_name_dot_dots_len = 5;
   ...
   int i312_id;
   int f313_id;
   int var_dash_name_dash_dashes_id;
   int var_dot_name_dot_dots_id;
...
#  define RANK_i312 3
#  define RANK_f313 3
#  define RANK_var_dash_name_dash_dashes 0
#  define RANK_var_dot_name_dot_dots 0
   ...
   /* attribute vectors */
   int c_att_dash_name_dash_dashes[1];
   int c_att_dot_name_dot_dots[1];
   int s_b[4];
   short s_s[3];
   int i_i[3];
   float i_f[3];
   ...
   float cdf_Gf[3];
   double cdf_Gd[3];
   int cdf_Gatt_dash_name_dash_dashes[1];
   int cdf_Gatt_dot_name_dot_dots[1];
   ...
   check_err(stat,__LINE__,__FILE__);
   stat = nc_def_dim(ncid, "dim-name-dashes", dim_dash_name_dash_dashes_len, &dim_dash_name_dash_dashes_dim);
   check_err(stat,__LINE__,__FILE__);
   stat = nc_def_dim(ncid, "dim.name.dots", dim_dot_name_dot_dots_len, &dim_dot_name_dot_dots_dim);
   check_err(stat,__LINE__,__FILE__);
   ...
   stat = nc_def_var(ncid, "var-name-dashes", NC_DOUBLE, RANK_var_dash_name_dash_dashes, 0, &var_dash_name_dash_dashes_id);
   check_err(stat,__LINE__,__FILE__);

   stat = nc_def_var(ncid, "var.name.dots", NC_DOUBLE, RANK_var_dot_name_dot_dots, 0, &var_dot_name_dot_dots_id);
   check_err(stat,__LINE__,__FILE__);

   /* assign attributes */
   c_att_dash_name_dash_dashes[0] = 4;
   stat = nc_put_att_int(ncid, c_id, "att-name-dashes", NC_INT, 1, c_att_dash_name_dash_dashes);
   check_err(stat,__LINE__,__FILE__);
   c_att_dot_name_dot_dots[0] = 5;
   stat = nc_put_att_int(ncid, c_id, "att.name.dots", NC_INT, 1, c_att_dot_name_dot_dots);
   check_err(stat,__LINE__,__FILE__);
   ...
   check_err(stat,__LINE__,__FILE__);
   cdf_Gatt_dash_name_dash_dashes[0] = -1;
   stat = nc_put_att_int(ncid, NC_GLOBAL, "Gatt-name-dashes", NC_INT, 1, cdf_Gatt_dash_name_dash_dashes);
   check_err(stat,__LINE__,__FILE__);
   cdf_Gatt_dot_name_dot_dots[0] = -2;
   stat = nc_put_att_int(ncid, NC_GLOBAL, "Gatt.name.dots", NC_INT, 1, cdf_Gatt_dot_name_dot_dots);
   check_err(stat,__LINE__,__FILE__);
   ...
   {			/* store var-name-dashes */
    static double var_dash_name_dash_dashes = -1.;
    stat = nc_put_var_double(ncid, var_dash_name_dash_dashes_id, &var_dash_name_dash_dashes);
    check_err(stat,__LINE__,__FILE__);
   }

   {			/* store var.name.dots */
    static double var_dot_name_dot_dots = -2.;
    stat = nc_put_var_double(ncid, var_dot_name_dot_dots_id, &var_dot_name_dot_dots);
    check_err(stat,__LINE__,__FILE__);
   }
   stat = nc_close(ncid);
   check_err(stat,__LINE__,__FILE__);
