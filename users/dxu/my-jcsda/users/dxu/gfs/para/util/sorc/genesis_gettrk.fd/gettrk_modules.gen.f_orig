...
c
      module contours
        integer, parameter :: maxconts=1001 ! max # of cont. intervals
...
c
      module phase
        character*1 , save ::   phaseflag   ! Will phase be determined
                                            ! (y/n)                   
        character*3 , save ::   phasescheme ! What scheme to use:
...
c
      module set_max_parms
        ...
        integer, parameter :: maxmodel=8   ! max # of models currently 
                                           ! available
