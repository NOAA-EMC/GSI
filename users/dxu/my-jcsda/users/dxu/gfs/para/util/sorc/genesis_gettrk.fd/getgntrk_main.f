...
c       files had this parm at 850 & 700 (GFS_ENS, ECMWF & UKMET do NOT), then 
...
C         case ('AVN','NGM','ETA','GFD','AP0','AN0','AP1','AN1','AC0')
          case ('AVN','NGM','ETA','GFD','EP0','EP1','EC0')
            write (61,81) atcfnum,atcfname
     &           ,inp%byy,inp%bmm,inp%bdd,inp%bhh,intlat(1),intlon(1)
...
c
     ...
     &      atcfname(1:3) == 'EP0' .or. atcfname(1:3) == 'EC0' .or.
C    &      atcfname(1:3) == 'AP0' .or. atcfname(1:3) == 'AN0' .or.
C    &      atcfname(1:3) == 'AP1' .or. atcfname(1:3) == 'AN1' .or.
C    &      atcfname(1:3) == 'AC0' .or. atcfname == 'AEAR' .or.
     &      atcfname(1:3) == 'EP1' .or. atcfname == 'AEAR' .or.
     &      atcfname(1:3) == 'CMC' .or. atcfname(1:3) == 'EMX') then
          errmax  = err_avn_init
          errinit = err_avn_init
        elseif (atcfname(1:3) == 'WP0' .or. atcfname(1:3) == 'WN0' .or.
     ...
     &         atcfname(1:3) == 'ZP1' .or. atcfname(1:3) == 'ZN1') then
          errmax  = err_avn_init
          errinit = err_avn_init
        elseif (atcfname(1:3) == 'EP0' .or. atcfname(1:3) == 'EP1' .or.
