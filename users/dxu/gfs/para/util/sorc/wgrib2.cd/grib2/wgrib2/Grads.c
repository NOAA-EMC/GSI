...
/*
 * HEADER:100:ctl_inv:inv:0:ctl inventory dump for g2ctl/GrADS
 */
int f_ctl_inv(ARG0) {
...
/*
 * HEADER:200:lev0:inv:0:level for g2ctl/GrADS
 */
int f_lev0(ARG0) {
    int center;
    int level_type1, level_type2;
...
/*
 * HEADER:100:ctl_ens:inv:0:ens info for g2ctl/GrADS
 */
