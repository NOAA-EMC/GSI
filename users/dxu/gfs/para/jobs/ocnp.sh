...
export aveHrlyNc=${aveHrlyNc:-$HOMEDIR/exec/${cfsd}aveHrlyNc}
export aveHrlyIceNc=${aveHrlyIceNc:-$HOMEDIR/exec/${cfsd}aveHrlyIceNc}
export APRUN=${APRUN:-""}
...
export OCN2GRIBEXEC=${OCN2GRIBEXEC:-$HOMEDIR/exec/${cfsp}tripo2reg}
#
...
export FCST_TIMEMEANSH=${FCST_TIMEMEANSH:-$HOMEDIR/ush/fcst_timemean.sh}
...
export FCST_TSERSH=${FCST_TSERSH:-$HOMEDIR/ush/fcst_timeser.sh}
...
if [ $DO_POST = YES ] ; then
  ...
  #
  #export FIX_OM=${FIX_OM:-$HOMEDIR/fix/fix_om/}
