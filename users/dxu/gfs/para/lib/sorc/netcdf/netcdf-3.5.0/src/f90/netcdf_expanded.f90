   ...
   function nf90_get_var_FourByteInt(ncid, varid, values, start)
     ...
     nf90_get_var_FourByteInt = nf_get_var1_int(ncid, varid, localIndex, values)
   ...
   function nf90_get_var_1D_FourByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_FourByteInt = &
          nf_get_varm_int(ncid, varid, localStart, localCount, localStride, localMap, values)
     else
       nf90_get_var_1D_FourByteInt = &
          nf_get_vars_int(ncid, varid, localStart, localCount, localStride, values)
     end if
