...
export DATDIR=/u/wx20es/nbns/$SUFFIX
...
#scp wx20es@haze1.rdhpcs.noaa.gov:$DATDIR_org/cnvstat.gdas.${PDATE} $DATDIR/cnvstat.${PDATE}
#  scp wx20es@haze1.rdhpcs.noaa.gov:$DATDIR_org/pgbanl.gdas.${PDATE} $DATDIR/pgbanl.${PDATE}
#  scp wx20es@haze1.rdhpcs.noaa.gov:$DATDIR_org/pgbf06.gdas.${GDATE} $DATDIR/pgbf06.${GDATE}
#err=$?
if [  -s $DATDIR/cnvstat.gdas.${PDATE} ];then
   /bin/sh $SCRIPTS/con${SUFFIX}.sh
