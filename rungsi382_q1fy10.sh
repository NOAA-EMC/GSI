...
datges=/global/shared/glopara/prd09q1o
...
##$ncp /ptmp/wx22dk/CRON/com/gfs/prod/gdas.$sdate/gdas1.t${hh}z.eshrs3.tm00.bufr_d ./hirs3bufrears
##$ncp /ptmp/wx22dk/CRON/com/gfs/prod/gdas.$sdate/gdas1.t${hh}z.esamua.tm00.bufr_d ./amusabufrears
##$ncp /ptmp/wx22dk/CRON/com/gfs/prod/gdas.$sdate/gdas1.t${hh}z.esamub.tm00.bufr_d ./amsubbufrears
