...
!       Process file if it exists
        if (lexist) then
           ...
           write(6,*)' Task ',mype,' processing file ',trim(diag_rad)
              
           call read_diag_header(lndiag,header_fix,header_chan)
...
!       Requested file not found
           ...
           write(6,*)' Task ',mype,' can not find file ',trim(diag_rad)

!       End of process file block
        endif
...
!
     do i=1,ndat
        ...
        write(6,*)' seeking update file i=',i,' with fname=',trim(fname),' ',lexist
