...
!
!   input argument list:
!     stats_oz - array holding sums fro various statistical output
...
! Declare local variables
  ...
  integer(i_kind) j,iasim,i,icerr,jsat,ii
  real(r_kind) svar,rsum,stdev,cpen,penalty_all,qcpenalty_all
  real(r_kind),dimension(ndat):: rpenal,qcpenal,qccount_asim
...
! Compute and print statistics for ozone data
  ...
  write(iout_oz,875) ozmz
850 format('OUTER ITERATION jiter=',i5)
875 format(' ozmz = ',8g12.6/,(8x,8g12.6))
