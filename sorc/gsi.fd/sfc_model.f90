...
!   t2 , q2                : 2-m high observed virtual (or sensible) temperature and mixing ratio
!
!-----------------------------------------------------------------------------!
!  
...
!-----------------------------------------------------------------------------!
      ...
      use constants, only: grav,fv,rd_over_cp,zero,quarter,half,one,two,four,five,r1000
      ...
      REAL(r_kind), INTENT (in)                :: hs, roughness, xland
