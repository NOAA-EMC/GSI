...
! !USES:
  ...
  use guess_grids, only: hrdifsig,ges_ps,geop_hgtl,ges_lnprsl,fact10,&
       nfldsig,nfldsfc,hrdifsfc,ges_u,ges_v
...
! Declare local variables
  ...
  real(r_kind) val,valqc,ddiff,rwgt
