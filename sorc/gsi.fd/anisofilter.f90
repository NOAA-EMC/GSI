...
! Uses:
  ...
  use guess_grids, only: ges_u,ges_v,ges_prsl,ges_tv,ges_z,ntguessig,ozmz, & 
...
!   2008-07-01  pondeca - add terrain following covariances.
  ...
  do k=kps,kpe
    ...
    do j=jps,jpe
      do i=ips,ipe
             ...
             if(ivar.eq. 6) factk=max(0.0002_r_kind,ozmz(kvar))*r25       ! ozone
