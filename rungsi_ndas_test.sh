...
# Set analysis date and experiment name
adate=2008082212
exp=testqc	
...
# gsiexec=/global/save/wx20rt/gsi_anl/sorc/q1fy10/global_gsi
gsiexec=/global/save/wx23jd/bk2/global_gsi
...
tmpdir=/ptmp/wx23jd/tmpreg_ndas_$FORMAT/$exp
savdir=/ptmp/wx23jd/outreg/ndas_$FORMAT/$exp
...
datges=/global/save/wx20rt/gsi_anl/cases/regional/ndas_$FORMAT/$adate
...
cat << EOF > gsiparm.anl
 ...
 /
 &OBSQC
   dfact=0.75,dfact1=3.0,noiqc=.true.,c_varqc=0.02,oberrflg=.false.,vadfile='prepbufr',
 /
 &OBS_INPUT
...
ozinfo=$fixjif09/global_ozinfo.txt
...
$ncp $datobs/${prefixa}.prepbufr.tm12   ./prepbufr
...
$ncp $datobs/${prefixa}.goesfv.$suffix  ./gsnd1bufr
$ncp $datobs/${prefixa}.airsev.$suffix  ./airsbufr
