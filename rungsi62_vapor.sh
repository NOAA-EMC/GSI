...
adate=2008082212
exp=test_all.48tasks.q1fy10_work


# Set path/file for gsi executable
basedir=/jcsda/save
gsipath=$basedir/wx20rt/gsi_anl
gsiexec=$gsipath/sorc/q1fy10_work/global_gsi
...
tmpdir=/ptmp/wx20rt/tmp${JCAP}_sigmap/$exp
savdir=/ptmp/wx20rt/out${JCAP}/sigmap/$exp

# Specify GSI fixed field and data directories.
fixgsi=/nwprod/fix
fixcrtm=/jcsda/save/wx20rt/2jif/Q1FY10_DA/fix/crtm_gfsgsi
fixjif09=/jcsda/save/wx20rt/2jif/Q1FY09_DA/fix
fixjif10=/jcsda/save/wx20rt/2jif/Q1FY10_DA/fix
...
dumpobs=gdas
dumpges=gdas
datobs=/jcsda/save/wx20rt/gsi_anl/cases/global/sigmap/$adate
datges=$datobs
...
cat << EOF > gsiparm.anl
 ...
 /
 &OBS_INPUT
   dmesh(1)=1800.0,dmesh(2)=1450.0,dmesh(3)=2400.0,dmesh(4)=1600.0,dmesh(5)=1800.0,dmesh(6)=1500.0,time_window_max=1.0,
...
$ncp $datges/${prefix_sfc}.bf09               ./sfcf06
...
$ss2gg siganl siganl.bin siganl.ctl 4 $LONA $LATA
$ss2gg sigf06 sigges.bin sigges.ctl 4 $LONA $LATA
