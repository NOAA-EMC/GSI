...
!    initialize counters for this set of output fields
    ...
    write(datdes(9),'("VARS 18")')
    write(datdes(10),'("pd   ",i5," 99 pd   ")')1
    write(datdes(11),'("fis  ",i5," 99 fis  ")')1
    write(datdes(12),'("t    ",i5," 99 t    ")')nsig
    write(datdes(13),'("q    ",i5," 99 q    ")')nsig
    write(datdes(14),'("u    ",i5," 99 u    ")')nsig
    write(datdes(15),'("v    ",i5," 99 v    ")')nsig
    write(datdes(16),'("sm   ",i5," 99 sm   ")')1
    write(datdes(17),'("sice ",i5," 99 sice ")')1
    write(datdes(18),'("sst  ",i5," 99 sst  ")')1
    write(datdes(19),'("vgty ",i5," 99 vgty ")')1
    write(datdes(20),'("slty ",i5," 99 slty ")')1
    write(datdes(21),'("vgfr ",i5," 99 vgfr ")')1
    write(datdes(22),'("sno  ",i5," 99 sno  ")')1
    write(datdes(23),'("u10  ",i5," 99 u10  ")')1
    write(datdes(24),'("v10  ",i5," 99 v10  ")')1
    write(datdes(25),'("smc  ",i5," 99 smc  ")')1
    write(datdes(26),'("stc  ",i5," 99 stc  ")')1
    write(datdes(27),'("tsk  ",i5," 99 tsk  ")')1
    write(datdes(28),'("ENDVARS")')
...
real(4),allocatable::temp1(:,:),tempb(:,:),temp3(:,:,:)
...
call retrieve_binary_nmm_field('AETA1',deta1,input_file,nsig)
call retrieve_binary_nmm_field('ETA1',deta1,input_file,nsig+1)
call retrieve_binary_nmm_field('DETA2',deta1,input_file,nsig)
call retrieve_binary_nmm_field('AETA2',deta1,input_file,nsig)
call retrieve_binary_nmm_field('ETA2',deta1,input_file,nsig+1)
...
allocate(temp1(im,jm),tempb(2*im-1,jm),itemp1(im,jm),temp3(im,nsig,jm))
