...
export envir=para
export DATAROOT=/gpfs/dell2/emc/verification/noscrub/${LOGNAME}/test_data
...
export NWTEST=/gpfs/dell2/emc/verification/noscrub/Edward.Safford/ProdGSI/util/Radiance_Monitor/nwprod
