...
module read_diag
  ...
  use kinds, only:  i_kind,r_single,r_kind,r_double,r_single
...
!  real(r_double),allocatable,dimension(:)               :: r_var_stor
...
! Declare local variables
  ...
  write(6,*) '---> read_radiag_data_nc_init'
  ...
  write(6,*) 'after BC_angord_arr_dim'

  nrecord = ndatum / header_fix%nchan
  diag_status%num_records = nrecord
  write(6,*) 'after diag_status%num_records'
  ...
  write(6,*) 'after header_fix%ijacob'
  ...
  write(6,*) 'after Sol_Zenith_Angle'
  ...
  write(6,*) 'after Land_Temperature'
  ...
  write(6,*) 'after Soil_Moisture'
  call nc_diag_read_get_var(ftin, 'tsavg5', tsavg5)
  write(6,*) 'after tsavg5'
  ...
  write(6,*) 'after BC_Cosine_Latitude_times_Node'
...
!  allocate(  all_data_chan(nrecord, nchan))
  ...
  write(6,*) 'after diag_status%cur_ob_idx'
