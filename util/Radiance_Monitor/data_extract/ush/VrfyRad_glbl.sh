...
if [[ -e ${radstat} ]]; then
   ...
   if [[ $MY_MACHINE = "wcoss" ]]; then
      ...
      $SUB -A $ACCOUNT -l procs=1,walltime=0:30:00 -N ${jobname} -V -o $LOGdir/data_extract.${PDY}.${CYC}.log -e $LOGdir/error_file.${PDY}.${CYC}.log $HOMEgdasradmon/jobs/JGDAS_VERFRAD
   fi
