...
subroutine write_to_disk(statstr)
   ...
   call nc_check( nf90_def_dim(ncid,'nlon',lonb,vardim(1)),myname,'def_dim nlon '//trim(filenameout) )
   call nc_check( nf90_def_dim(ncid,'nlat',latb,vardim(2)),myname,'def_dim nlat '//trim(filenameout) )
   call nc_check( nf90_def_dim(ncid,'nlev',nlevs,vardim(3)),myname,'def_dim nlev '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','surface pressure'),myname, 'put_att, var_name ps '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','zonal wind'),myname, 'put_att, var_name u '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','meridional wind'),myname, 'put_att, var_name v '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','temperature'),myname, 'put_att, var_name t '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','specific humidity'),myname, 'put_att, var_name q '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','ozone mixing ratio'),myname, 'put_att, var_name oz '//trim(filenameout) )
   ...
   call nc_check( nf90_put_att(ncid, varid, 'var_name','cloud-water mixing ratio'),myname, 'put_att, var_name cw '//trim(filenameout) )
