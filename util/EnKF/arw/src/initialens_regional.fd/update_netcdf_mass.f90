subroutine update_netcdf_mass(dh1,DateStr1,rmse_var,field3,nlon,nlat,nsig,iout)
!$$$  documentation block
!                .      .    .                                       .
...
!
  ...
  real(r_single),    intent(in) :: field3(nlon,nlat,nsig)
...
!
  write(iout,*) 
  write(iout,*) ' ================== '
  write(iout,*) ' write variable ', trim(rmse_var)
  write(iout,*) ' ================== '
...
!-------------  get grid info
  ...
  write(iout,*)' <<<<<<<<<<<<<<   write in data to dh1  = ',dh1       
