...
if(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
  include(gsiutils_compiler_flags_GNU_Fortran)
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "Intel")
  include(gsiutils_compiler_flags_Intel_Fortran)
else()
...
if(CMAKE_C_COMPILER_ID MATCHES "GNU")
  include(gsiutils_compiler_flags_GNU_C)
elseif(CMAKE_C_COMPILER_ID MATCHES "Intel")
  include(gsiutils_compiler_flags_Intel_C)
else()
