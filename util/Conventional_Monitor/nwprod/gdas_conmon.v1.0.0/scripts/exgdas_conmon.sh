...
################################################################################
   ...
   #  Directories
   export DATA=${DATA:-$(pwd)/workdir}			# work directory
   ...
   #  Filenames
   cnvstat=${cnvstat:-${C_COMIN}/${CYC}/gdas.t${CYC}z.cnvstat}
   if [[ ! -e ${cnvstat} ]]; then
...
#   pgrbf00=${pgrbf00:-${C_COMIN}/${CYC}/gdas.t${CYC}z.pgrb2.1p00.anl}
   pgrbf00=${pgrbf00:-${C_COMIN}/${CYC}/gdas.t${CYC}z.pgrb2.0p25.f000}
   if [[ ! -e ${pgrbf00} ]]; then
...
#   pgrbf06=${pgrbf06:-${C_COMINm6h}/${GCYC}/gdas.t${GCYC}z.pgrb2.1p00.f006}  
   pgrbf06=${pgrbf06:-${C_COMINm6h}/${GCYC}/gdas.t${GCYC}z.pgrb2.0p25.f006}  
   if [[ ! -e ${pgrbf06} ]]; then
