...
while(ix <=ixc)
'!rm -f info.txt'
'!cat pw_stas_1.ctl |grep "'ix' dtype=" > info.txt'
...
*'set yaxis ''minvar' 'maxvar' 'dy
  ...
  'd count.3'
if(iy =1)
'draw string 1.5 10.7 pw'stype'(assimilated):'title.1' on 'dd''hh
endif
if(iy=2)
'draw string 1.5 10.7 pw'stype'(rejected by gross check):'title.1' on 'dd''hh
endif
if(iy=3) 
'draw string 1.5 10.7 pw'stype'(monitored):'title.1' on 'dd''hh
endif
...
'set vrange 'minvar' 'maxvar
  ...
  'd  'field.nf.3
if(iy =1)
'draw string '1.5' 'ystring' pw'stype'(assimilated):'title.nf' on 'dd''hh
endif
if(iy=2)
'draw string '1.5' 'ystring' pw'stype'(rejected):'title.nf' on 'dd''hh
endif
if(iy=3)
'draw string '1.5' 'ystring' pw'stype'(monitoed):'title.nf' on 'dd''hh
endif
...
if(iy =1)
outfile='pw'stype'-'dd''hh'.png'
endif
if(iy =2)
outfile='pw'stype'_rej-'dd''hh'.png'
endif
if(iy =3)
outfile='pw'stype'_mon-'dd''hh'.png'
endif
