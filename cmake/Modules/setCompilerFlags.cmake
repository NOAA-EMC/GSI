...
#    set( OMPFLAG "-openmp" PARENT_SCOPE )
  ...
  message("Compiler OMPFLAG is ${OMPFLAG}")
  message("Compiler GSDCLOUDOPT is ${GSDCLOUDOPT}")
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    ...
    elseif( HOST-Luna OR HOST-Surge )
      set( MKL_FLAG "" )
      set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY -fp-model source -assume byterecl -convert big_endian -implicitnone -D_REAL8_ ${GSDCLOUDOPT} ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS}" PARENT_SCOPE)
      ...
      set(GSDCLOUD_Fortran_FLAGS "-convert big_endian" PARENT_SCOPE)
    else()
