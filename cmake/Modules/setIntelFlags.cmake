...
function(set_LIBRARY_UTIL_Intel)
    ...
    set(UTIL_Fortran_FLAGS "-O3 ${HOST_FLAG} -warn all,noexternal -implicitnone -traceback -fp-model strict -convert big_endian -DWRF -D_REAL8_ ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
...
#    set(COV_CALC_FLAGS "-O3 ${HOST_FLAG} -warn all -implicitnone -traceback -fp-model strict -convert little_endian -D_REAL8_ -openmp -fpp -auto" CACHE INTERNAL "" )
   set(COV_CALC_FLAGS "-O3 ${HOST_FLAG} -warn all,noexternal -implicitnone -traceback -fp-model strict -convert little_endian ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
...
function(set_LIBRARY_UTIL_Debug_Intel)
    ...
    set(UTIL_Fortran_FLAGS "-O0 ${HOST_FLAG} -warn all,noexternal -implicitnone -traceback -g -debug full -fp-model strict -convert big_endian -D_REAL8_ ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
    set(UTIL_COM_Fortran_FLAGS "-O0 -warn all,noexternal -implicitnone -traceback -g -debug full -fp-model strict -convert big_endian" CACHE INTERNAL "")
...
function (set_GSI_ENKF_Debug_Intel)
    set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -g -traceback -debug -ftrapuv -check all,noarg_temp_created -fp-stack-check -fstack-protector -warn all,nointerfaces,noexternal -convert big_endian -implicitnone -D_REAL8_ ${OpenMP_Fortran_FLAGS} ${MPI_Fortran_COMPILE_FLAGS} ${GSDCLOUDOPT}" CACHE INTERNAL "")
    set(ENKF_Fortran_FLAGS "-O0 ${HOST_FLAG} -warn all,noexternal -implicitnone -traceback -g -debug all -check all,noarg_temp_created -fp-model strict -convert big_endian -assume byterecl -D_REAL8_  ${OpenMP_Fortran_FLAGS} ${GSDCLOUDOPT}" CACHE INTERNAL "")
