...
# set(GSI_Fortran_FLAGS "-fp-model source -assume byterecl -convert big_endian -implicitnone -DWRF -D_REAL8_ -openmp" PARENT_SCOPE)
...
# set(GSI_Fortran_FLAGS "-O3 -traceback -convert big_endian -assume byterecl -g -fp-model source -DWRF -D_REAL8_ -openmp" PARENT_SCOPE)
  if( NOT DEFINED ENV{NETCDF_VER} )
    set(NETCDF_VER "3.6.3" PARENT_SCOPE)
  endif()
  if( NOT DEFINED ENV{BACIO_VER} )
