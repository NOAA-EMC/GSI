function (findSrc varName version varDir )
      if(EXISTS ${CMAKE_SOURCE_DIR}/src/${varName})
          message("setting source for ${varName} to be in src")
          set( ${varDir} "${CMAKE_SOURCE_DIR}/src/${varName}" PARENT_SCOPE)
          set( ${varCacheName} "${CMAKE_SOURCE_DIR}/src/${varName}" CACHE STRING "" FORCE )
      else()
