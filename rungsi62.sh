...
adate=2008082212
exp=opt
##exp=test_all.48tasks.q1fy10_vapor_ok.twin0_5


# Set path/file for gsi executable
basedir=/global/save
gsipath=$basedir/wx20rt/gsi_anl
gsiexec=$gsipath/sorc/q1fy10_vapor/global_gsi
...
dumpobs=gdas
dumpges=gdas
datobs=/global/save/wx20rt/gsi_anl/cases/global/sigmap/$adate
datges=$datobs
...
cat << EOF > gsiparm.anl
 ...
 /
 &OBS_INPUT
   dmesh(1)=180.0,dmesh(2)=145.0,dmesh(3)=240.0,dmesh(4)=160.0,dmesh(5)=180.0,dmesh(6)=150.0,time_window_max=0.5,
