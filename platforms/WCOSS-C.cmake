macro (setWCOSS_C)
  ...
  set(MKL_FLAG "" CACHE INTERNAL "Host Flag")
  set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY ${FP_MODEL_STRICT} ${BYTERECLEN} ${BIG_ENDIAN} ${IMPLICITNONE} -D_REAL8_ ${OpenMP_Fortran_FLAGS} ${MPI_Fortran_COMPILE_FLAGS} ${FOPT3}" CACHE INTERNAL "")
  set(ENKF_Fortran_FLAGS "${FOPT3} ${FP_MODEL_STRICT} ${BIG_ENDIAN} ${BYTERECLEN} ${IMPLICITNONE}  -DGFS -D_REAL8_ ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "")
